...
/// <summary>
/// 追跡対象プロパティ 1 件分の型安全な読み書きアクセサです。
/// プロパティ名文字列によるリフレクションの代わりに、コンパイル時に検証される
/// getter/setter デリゲート経由で値を読み書きします。
/// </summary>
public interface ITrackedProperty
{
    ...
    /// <summary>対象オブジェクトから現在値を取得します。</summary>
    object? GetValue(object target);

    /// <summary>対象オブジェクトへ値を設定します。</summary>
    void SetValue(object target, object? value);
}

/// <summary>getter / setter デリゲートによる <see cref="ITrackedProperty"/> 実装です。</summary>
