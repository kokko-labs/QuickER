...
- **Rich import/export** — import: DBML / Mermaid / Excel definition sheets / live DBs (5 dialects). Export: PNG / SVG / SQL DDL / Mermaid / DBML / Excel definition sheets / HTML definition documents / vector printing (scale-to-one-page and actual-size PDF)
