...
// Content hash: sha256:0bdc27c35cb711301839d56ed330231d3c8801a6ed228a34f3063f2e7ebff513
#nullable enable
...
public static partial class GeneratedRemoteEndpoints
{
    ...
    {
        RemoteServerEngine.MapCrud<CustomerEntity, int, ICustomerRemoteRepository>(
            group,
            "Customer"
        );
    }
    ...
    {
        RemoteServerEngine.MapCrud<ProductEntity, int, IProductRemoteRepository>(
            group,
            "Product"
        );
    }
    ...
    {
        RemoteServerEngine.MapCrud<OrderEntity, int, IOrderRemoteRepository>(
            group,
            "Order"
        );
    ...
    private sealed record Order_GetSummariesRequest(int CustomerId);
    ...
    {
        RemoteServerEngine.MapCrud<OrderLineEntity, int, IOrderLineRemoteRepository>(
            group,
            "OrderLine"
        );
    }
