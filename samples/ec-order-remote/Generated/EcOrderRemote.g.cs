...
// Content hash: sha256:5d4ee9fb7af11798c7ae44c8bfb7d91f11868252016f0234c2d8169779d358f3
#nullable enable
...
public partial class CustomerEditModel : EditModelBase<CustomerEditModel>
{
    ...
    /// <summary>Customer ID (primary key; assigned by the application) - Confirmed value of CustomerId (written by the input conversion and by the mapper when loading; treat it as read-only elsewhere).</summary>
        ...
        set
        {
            ...
            else
            {
                SetError(
                    ...
                    EditModelMessages.ParseFailed(nameof(CustomerId), GetDisplayName(nameof(CustomerId), "Customer ID (primary key; assigned by the application)"), normalized, "int")
                );
            }
        }
    }
    ...
    /// <summary>Customer name - Confirmed value of Name (written by the input conversion and by the mapper when loading; treat it as read-only elsewhere).</summary>
    public string? Name
    {
        get => _name;
        internal set
    ...
    /// <summary>Contact email address (optional) - Confirmed value of Email (written by the input conversion and by the mapper when loading; treat it as read-only elsewhere).</summary>
    public string? Email
    {
        get => _email;
        internal set
    ...
    /// <summary>Called just before the confirmed value of Email changes (new value only; add processing via a partial implementation).</summary>
    partial void OnEmailChanging(string? value);

    /// <summary>Called just before the confirmed value of Email changes (old and new values; add processing via a partial implementation).</summary>
    partial void OnEmailChanging(string? oldValue, string? newValue);

    /// <summary>Called just after the confirmed value of Email changes (new value only; add processing via a partial implementation).</summary>
    ...
    private static readonly IReadOnlyList<EditModelColumn<CustomerEditModel>> _editModelColumns =
        new EditModelColumn<CustomerEditModel>[]
        {
            new(
                ...
                true,
                false,
                static () => GetDisplayName(nameof(CustomerId), "Customer ID (primary key; assigned by the application)"),
            ...
            new(
                ...
                true,
                false,
                static () => GetDisplayName(nameof(Name), "Customer name"),
            ...
            new(
                ...
                false,
                false,
                static () => GetDisplayName(nameof(Email), "Contact email address (optional)"),
                static model => model.Email,
                static (model, value) => model.Email = (string?)value,
                static model => model.Email?.ToString() ?? string.Empty,
                static (model, input) => model.BindingEmail = input
            ),
        };
...
/// <summary>Product master. Defines the products available for sale</summary>
public partial class ProductEditModel : EditModelBase<ProductEditModel>
{
    // Each column keeps two representations: the confirmed value and the on-screen input string (conversion errors are held by the error dictionary).
    ...
    /// <summary>Product ID (primary key; assigned by the application) - Confirmed value of ProductId (written by the input conversion and by the mapper when loading; treat it as read-only elsewhere).</summary>
    ...
    /// <summary>Called just before the confirmed value of ProductId changes (new value only; add processing via a partial implementation).</summary>
    partial void OnProductIdChanging(int? value);

    /// <summary>Called just before the confirmed value of ProductId changes (old and new values; add processing via a partial implementation).</summary>
    partial void OnProductIdChanging(int? oldValue, int? newValue);

    /// <summary>Called just after the confirmed value of ProductId changes (new value only; add processing via a partial implementation).</summary>
        ...
        set
        {
            ...
            else
            {
                SetError(
                    ...
                    EditModelMessages.ParseFailed(nameof(ProductId), GetDisplayName(nameof(ProductId), "Product ID (primary key; assigned by the application)"), normalized, "int")
                );
            }
        }
    }
    ...
    /// <summary>Product name - Confirmed value of Name (written by the input conversion and by the mapper when loading; treat it as read-only elsewhere).</summary>
    public string? Name
    {
        get => _name;
        internal set
    ...
    /// <summary>Unit sales price in the product master - Confirmed value of UnitPrice (written by the input conversion and by the mapper when loading; treat it as read-only elsewhere).</summary>
    ...
    /// <summary>Called just before the confirmed value of UnitPrice changes (new value only; add processing via a partial implementation).</summary>
    partial void OnUnitPriceChanging(decimal? value);

    /// <summary>Called just before the confirmed value of UnitPrice changes (old and new values; add processing via a partial implementation).</summary>
    partial void OnUnitPriceChanging(decimal? oldValue, decimal? newValue);

    /// <summary>Called just after the confirmed value of UnitPrice changes (new value only; add processing via a partial implementation).</summary>
        ...
        set
        {
            ...
            else
            {
                SetError(
                    ...
                    EditModelMessages.ParseFailed(nameof(UnitPrice), GetDisplayName(nameof(UnitPrice), "Unit sales price in the product master"), normalized, "decimal")
                );
            }
        }
    }
    ...
    /// <summary>The columns of this edit model as data (input of the shared required check, input revert, row-edit snapshot, and duplicate-error mapping).</summary>
    private static readonly IReadOnlyList<EditModelColumn<ProductEditModel>> _editModelColumns =
        new EditModelColumn<ProductEditModel>[]
        {
            new(
                nameof(ProductId),
                nameof(BindingProductId),
                true,
                false,
                static () => GetDisplayName(nameof(ProductId), "Product ID (primary key; assigned by the application)"),
                static model => model.ProductId,
                static (model, value) => model.ProductId = (int?)value,
                static model => model.ProductId?.ToString() ?? string.Empty,
                static (model, input) => model.BindingProductId = input
            ),
            new(
                nameof(Name),
                nameof(BindingName),
                true,
                false,
                static () => GetDisplayName(nameof(Name), "Product name"),
                static model => model.Name,
                static (model, value) => model.Name = (string?)value,
                static model => model.Name?.ToString() ?? string.Empty,
                static (model, input) => model.BindingName = input
            ...
            new(
                ...
                true,
                false,
                static () => GetDisplayName(nameof(UnitPrice), "Unit sales price in the product master"),
                static model => model.UnitPrice,
                static (model, value) => model.UnitPrice = (decimal?)value,
                static model => model.UnitPrice?.ToString() ?? string.Empty,
                static (model, input) => model.BindingUnitPrice = input
            ),
        };

    /// <inheritdoc />
    protected override IReadOnlyList<EditModelColumn<ProductEditModel>> EditModelColumns =>
        _editModelColumns;
    ...
    /// <param name="cancellationToken">The cancellation token.</param>
    public Task<bool> ValidateUniqueAsync(
        IProductRemoteRepository repository,
        CancellationToken cancellationToken = default
    )
    {
        // Only the columns the check reads are copied: the primary key (to exclude this row) and the constraint members.
...
public partial class OrderEditModel : EditModelBase<OrderEditModel>
{
    ...
    /// <summary>Order ID (primary key; assigned by the application) - Confirmed value of OrderId (written by the input conversion and by the mapper when loading; treat it as read-only elsewhere).</summary>
    public int? OrderId
    {
        get => _orderId;
        internal set
        ...
        set
        {
            ...
            else
            {
                SetError(
                    ...
                    EditModelMessages.ParseFailed(nameof(OrderId), GetDisplayName(nameof(OrderId), "Order ID (primary key; assigned by the application)"), normalized, "int")
                );
            }
        }
    }
    ...
    /// <summary>ID of the ordering customer (foreign key to customers) - Confirmed value of CustomerId (written by the input conversion and by the mapper when loading; treat it as read-only elsewhere).</summary>
    public int? CustomerId
    {
        get => _customerId;
        internal set
    ...
    public string BindingCustomerId
    {
        ...
        set
        {
            ...
            else
            {
                SetError(
                    nameof(BindingCustomerId),
                    EditModelMessages.ParseFailed(nameof(CustomerId), GetDisplayName(nameof(CustomerId), "ID of the ordering customer (foreign key to customers)"), normalized, "int")
                );
            }
        }
    }
    ...
    /// <summary>Date and time the order was placed - Confirmed value of OrderedAt (written by the input conversion and by the mapper when loading; treat it as read-only elsewhere).</summary>
        ...
        set
        {
            ...
            else
            {
                SetError(
                    ...
                    EditModelMessages.ParseFailed(nameof(OrderedAt), GetDisplayName(nameof(OrderedAt), "Date and time the order was placed"), normalized, "DateTime")
                );
            }
        }
    }
    ...
    /// <summary>Memo attached to the order (optional) - Confirmed value of Memo (written by the input conversion and by the mapper when loading; treat it as read-only elsewhere).</summary>
    public string? Memo
    {
        get => _memo;
        internal set
    ...
    private static readonly IReadOnlyList<EditModelColumn<OrderEditModel>> _editModelColumns =
        new EditModelColumn<OrderEditModel>[]
        {
            new(
                ...
                true,
                false,
                static () => GetDisplayName(nameof(OrderId), "Order ID (primary key; assigned by the application)"),
            ...
            new(
                ...
                true,
                false,
                static () => GetDisplayName(nameof(CustomerId), "ID of the ordering customer (foreign key to customers)"),
                static model => model.CustomerId,
                static (model, value) => model.CustomerId = (int?)value,
                static model => model.CustomerId?.ToString() ?? string.Empty,
                static (model, input) => model.BindingCustomerId = input
            ...
            new(
                ...
                false,
                false,
                static () => GetDisplayName(nameof(Memo), "Memo attached to the order (optional)"),
...
public partial class OrderLineEditModel : EditModelBase<OrderLineEditModel>
{
    ...
    /// <summary>Order line ID (primary key; assigned by the application) - Confirmed value of OrderLineId (written by the input conversion and by the mapper when loading; treat it as read-only elsewhere).</summary>
    ...
    /// <summary>Called just before the confirmed value of OrderLineId changes (new value only; add processing via a partial implementation).</summary>
    partial void OnOrderLineIdChanging(int? value);

    /// <summary>Called just before the confirmed value of OrderLineId changes (old and new values; add processing via a partial implementation).</summary>
    partial void OnOrderLineIdChanging(int? oldValue, int? newValue);

    /// <summary>Called just after the confirmed value of OrderLineId changes (new value only; add processing via a partial implementation).</summary>
        ...
        set
        {
            ...
            else
            {
                SetError(
                    ...
                    EditModelMessages.ParseFailed(nameof(OrderLineId), GetDisplayName(nameof(OrderLineId), "Order line ID (primary key; assigned by the application)"), normalized, "int")
                );
            }
        }
    }
    ...
    /// <summary>ID of the parent order (foreign key to orders) - Confirmed value of OrderId (written by the input conversion and by the mapper when loading; treat it as read-only elsewhere).</summary>
    public int? OrderId
    {
        get => _orderId;
        internal set
    ...
    public string BindingOrderId
    {
        ...
        set
        {
            ...
            else
            {
                SetError(
                    nameof(BindingOrderId),
                    EditModelMessages.ParseFailed(nameof(OrderId), GetDisplayName(nameof(OrderId), "ID of the parent order (foreign key to orders)"), normalized, "int")
                );
            }
        }
    }
    ...
    /// <summary>ID of the target product (foreign key to products) - Confirmed value of ProductId (written by the input conversion and by the mapper when loading; treat it as read-only elsewhere).</summary>
    public int? ProductId
    {
        get => _productId;
        internal set
    ...
    public string BindingProductId
    {
        ...
        set
        {
            ...
            else
            {
                SetError(
                    nameof(BindingProductId),
                    EditModelMessages.ParseFailed(nameof(ProductId), GetDisplayName(nameof(ProductId), "ID of the target product (foreign key to products)"), normalized, "int")
                );
            }
        }
    }
    ...
    /// <summary>Order quantity - Confirmed value of Quantity (written by the input conversion and by the mapper when loading; treat it as read-only elsewhere).</summary>
    public int? Quantity
    {
        get => _quantity;
        internal set
        ...
        set
        {
            ...
            else
            {
                SetError(
                    ...
                    EditModelMessages.ParseFailed(nameof(Quantity), GetDisplayName(nameof(Quantity), "Order quantity"), normalized, "int")
                );
            }
        }
    }
    ...
    /// <summary>Unit price at order time (kept on the order line so product-master price revisions do not affect it) - Confirmed value of UnitPrice (written by the input conversion and by the mapper when loading; treat it as read-only elsewhere).</summary>
    public decimal? UnitPrice
    {
        get => _unitPrice;
        internal set
    ...
    public string BindingUnitPrice
    {
        ...
        set
        {
            ...
            else
            {
                SetError(
                    nameof(BindingUnitPrice),
                    EditModelMessages.ParseFailed(nameof(UnitPrice), GetDisplayName(nameof(UnitPrice), "Unit price at order time (kept on the order line so product-master price revisions do not affect it)"), normalized, "decimal")
                );
            }
        }
    }
    ...
    /// <summary>Product navigation property (reference to the parent side).</summary>
    /// <remarks>
    /// Nothing in the generated code assigns it: loading does not follow a reference back to the parent (that would recurse), so it
    /// stays null unless application code sets it. The cascade parent is exposed by ParentModel, which the owning collection or
    /// single reference keeps up to date; this property is kept for application code that wants a navigation of its own.
    ...
    private static readonly IReadOnlyList<EditModelColumn<OrderLineEditModel>> _editModelColumns =
        new EditModelColumn<OrderLineEditModel>[]
        {
            new(
                ...
                true,
                false,
                static () => GetDisplayName(nameof(OrderLineId), "Order line ID (primary key; assigned by the application)"),
                static model => model.OrderLineId,
                static (model, value) => model.OrderLineId = (int?)value,
                static model => model.OrderLineId?.ToString() ?? string.Empty,
                static (model, input) => model.BindingOrderLineId = input
            ),
            new(
                nameof(OrderId),
                nameof(BindingOrderId),
                true,
                false,
                static () => GetDisplayName(nameof(OrderId), "ID of the parent order (foreign key to orders)"),
                static model => model.OrderId,
                static (model, value) => model.OrderId = (int?)value,
                static model => model.OrderId?.ToString() ?? string.Empty,
                static (model, input) => model.BindingOrderId = input
            ...
            new(
                ...
                true,
                false,
                static () => GetDisplayName(nameof(ProductId), "ID of the target product (foreign key to products)"),
                static model => model.ProductId,
                static (model, value) => model.ProductId = (int?)value,
                static model => model.ProductId?.ToString() ?? string.Empty,
                static (model, input) => model.BindingProductId = input
            ...
            new(
                ...
                true,
                false,
                static () => GetDisplayName(nameof(Quantity), "Order quantity"),
                static model => model.Quantity,
                static (model, value) => model.Quantity = (int?)value,
            ...
            new(
                ...
                true,
                false,
                static () => GetDisplayName(nameof(UnitPrice), "Unit price at order time (kept on the order line so product-master price revisions do not affect it)"),
                static model => model.UnitPrice,
                static (model, value) => model.UnitPrice = (decimal?)value,
                static model => model.UnitPrice?.ToString() ?? string.Empty,
                static (model, input) => model.BindingUnitPrice = input
...
/// <summary>Converts between ProductEntity and ProductEditModel.</summary>
public sealed partial class ProductMapper
    : MapperBase<ProductEntity, ProductEditModel>
{
    /// <inheritdoc />
    protected override void AfterEntityCreated(ProductEntity entity) =>
        OnEntityCreated(entity);

    /// <summary>Called just after a new ProductEntity is created (set initial values via a partial implementation).</summary>
    /// <remarks>Every conversion creates a fresh entity, so this also fires when an existing edit model is converted (<c>CreateEntity(editModel, …)</c>), and the RowState at this point is always Added - the edit model's state is transferred later, at the end of the column copy.</remarks>
    partial void OnEntityCreated(ProductEntity entity);

    /// <inheritdoc />
    protected override void AfterEditModelCreated(ProductEditModel editModel) =>
        OnEditModelCreated(editModel);

    /// <summary>Called just after a new ProductEditModel is created (after loading) (set initial values via a partial implementation; branch on IsAdded to target new models only).</summary>
    ...
    )
    {
        ...
        // A removed row takes part in the save through its key alone, so an absent value is skipped instead of enforced.
        if (!editModel.IsRemoved || editModel.UnitPrice is not null)
        {
            entity.UnitPrice = Required(editModel.UnitPrice, nameof(editModel.UnitPrice));
        }
    ...
    /// <summary>Called after the ProductEditModel's confirmed values are applied to the ProductEntity (save additional properties via a partial implementation).</summary>
    ...
    {
        editModel.ProductId = entity.ProductId;
        editModel.Name = entity.Name;
        editModel.UnitPrice = entity.UnitPrice;
    }

    /// <inheritdoc />
    protected override void CompleteLoad(ProductEntity entity, ProductEditModel editModel)
    {
        editModel.OrderLines = new OrderLineMapper().CreateEditModels(entity.OrderLines);
        OnEditModelLoaded(entity, editModel);
    }

    /// <summary>Called after the default load into the ProductEditModel (load additional properties via a partial implementation).</summary>
    ...
    : MapperBase<OrderEntity, OrderEditModel>
{
    ...
    )
    {
        ...
        // A removed row takes part in the save through its key alone, so an absent value is skipped instead of enforced.
        if (!editModel.IsRemoved || editModel.OrderedAt is not null)
        {
            entity.OrderedAt = Required(editModel.OrderedAt, nameof(editModel.OrderedAt));
        }
    ...
    : MapperBase<OrderLineEntity, OrderLineEditModel>
{
    ...
    {
        entity.OrderLineId = Required(editModel.OrderLineId, nameof(editModel.OrderLineId));
        ...
        // A removed row takes part in the save through its key alone, so an absent value is skipped instead of enforced.
        if (!editModel.IsRemoved || editModel.ProductId is not null)
        {
            entity.ProductId = Required(editModel.ProductId, nameof(editModel.ProductId));
        }
    ...
    {
        editModel.OrderLineId = entity.OrderLineId;
        editModel.OrderId = entity.OrderId;
        editModel.ProductId = entity.ProductId;
...
public sealed partial class OrderRepository(
    ...
    ISaveHookRegistry? saveHooks = null,
    ISqlExecutor? sqlExecutor = null
) : SqliteRepository<OrderEntity, int>(connectionFactory, saveHooks, sqlExecutor), IOrderRepository
{
    /// <summary>Searches a customer's orders, newest first (order ID descending), with paging</summary>
    ...
    private static readonly Expression<Func<OrderEntity, OrderSummaryRow>> _getSummariesAsyncSelector = e => new OrderSummaryRow { OrderId = e.OrderId, OrderedAt = e.OrderedAt, Memo = e.Memo };

    /// <summary>Gets a customer's order summaries (order ID, ordered-at, memo), newest first (projection DTO)</summary>
    public Task<IReadOnlyList<OrderSummaryRow>> GetSummariesAsync(int customerId, CancellationToken cancellationToken = default) =>
        Query().Where(e => e.CustomerId == customerId).OrderByDescending(e => e.OrderId).ToProjectionListAsync(_getSummariesAsyncSelector, cancellationToken);
...
public static class SqlQueryExtensions
{
    ...
    /// <summary>Fetches the single entity with the given key - the same key the repository contract's GetByIdAsync takes - and returns null when no row matches.</summary>
    /// <remarks>Combine it with Include or IncludeGraph to fetch that entity together with its graph in one call.</remarks>
    public static Task<ProductEntity?> GetByIdAsync(
        this SqlQuery<ProductEntity> query,
        int id,
        CancellationToken cancellationToken = default
    ) => query.Where(entity => entity.ProductId == id).FirstOrDefaultAsync(cancellationToken);

    /// <summary>Fetches the single entity with the given key, keeping the Include chain written just before it (returns null when no row matches).</summary>
    public static Task<ProductEntity?> GetByIdAsync<TProperty>(
        this IncludableSqlQuery<ProductEntity, TProperty> query,
        int id,
        CancellationToken cancellationToken = default
    ) => query.Where(entity => entity.ProductId == id).FirstOrDefaultAsync(cancellationToken);
    ...
    public static Task<OrderLineEntity?> GetByIdAsync(
        ...
        int id,
        CancellationToken cancellationToken = default
    ) => query.Where(entity => entity.OrderLineId == id).FirstOrDefaultAsync(cancellationToken);
