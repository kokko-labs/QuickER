...
実装側の変更が反映されないまま置かれると、図は少しずつ実態からずれ、やがて誰も見なくなります。
...
狙いは、ER モデルを正本とする開発の仕組みを提供することです。
同じスキーマ情報を何度も書き写す手間を最小限に抑え、高品質な業務アプリケーションを、より速く、より少ないコストで開発できるようにします。
