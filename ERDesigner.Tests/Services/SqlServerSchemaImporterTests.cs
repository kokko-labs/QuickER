...
public class SqlServerSchemaImporterTests
{
    ...
    {
        var a = new Entity { TableName = "T", Columns = { new Column { Name = "Id", DataType = "int", IsPrimaryKey = true } } };
        var b = new Entity { TableName = "T", Columns = { new Column { Name = "Id", DataType = "int", IsPrimaryKey = true } } };

        var sigA = SqlServerSchemaImporter.ComputeSignature(new[] { a }, System.Array.Empty<Relationship>());
        var sigB = SqlServerSchemaImporter.ComputeSignature(new[] { b }, System.Array.Empty<Relationship>());
    ...
    {
        var a = new Entity { TableName = "T", Columns = { new Column { Name = "Id", DataType = "int" } } };
        var b = new Entity { TableName = "T", Columns = { new Column { Name = "Id", DataType = "bigint" } } };
