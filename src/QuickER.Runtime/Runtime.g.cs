        ...
        IEditableObject
{
    ...
    public void SetParentModel(EditModelBaseCore? parentModel)
    {
    ...
    where T : EditModelBaseCore
{
    ...
    public EditModelBaseCore? OwnerModel
    {
        get => _ownerModel;
        set
        {
...
/// </remarks>
public sealed class SaveHookRegistry : ISaveHookRegistry
{
...
/// </remarks>
public static class QuerySelectorCache
{
...
/// </para>
/// </remarks>
public static class QueryValueEvaluator
{
    /// <summary>
