...
public class OracleDdlGeneratorTests
{
        ...
        var diagram = new ErDiagram
        {
            Entities =
            {
                new Entity
                {
                    ...
                    Columns =
                    {
                        new Column { Name = "C", DataType = "NUMBER(10)" },
                    },
                },
            },
        };
    ...
    public void Build_WithoutPrimaryKey_KeepsCommaBeforeUnique()
    {
        ...
        sql.Should().Contain("\"region\" VARCHAR2(10) NOT NULL,");
        sql.Should().Contain("CONSTRAINT \"UQ_shops_code\" UNIQUE (\"code\")");
    }
    ...
    public void Build_WithoutUniqueConstraints_EmitsNoUnique()
    {
        ...
        new OracleDdlGenerator().Build(diagram).Should().NotContain("UNIQUE");
    }
    ...
    public void Build_CompositePrimaryKey_FollowsPrimaryKeyColumnIds()
    {
        ...
        var sql = new OracleDdlGenerator().Build(new ErDiagram { Entities = { entity } });
