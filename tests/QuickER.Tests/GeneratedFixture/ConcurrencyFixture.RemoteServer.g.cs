        ...
        group.MapPost(
            ...
            (HttpContext context) =>
                ExecuteAsync(
                    ...
                    async () =>
                    {
                        var request = await ReadRequestAsync<GadgetCheckUniquenessRequest>(context).ConfigureAwait(false);
        ...
        group.MapPost(
            ...
            (HttpContext context) =>
                ExecuteAsync(
                    ...
                    async () =>
                    {
                        var request = await ReadRequestAsync<GadgetNoteCheckUniquenessRequest>(context).ConfigureAwait(false);
