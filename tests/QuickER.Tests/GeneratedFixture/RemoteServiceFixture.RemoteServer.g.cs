...
// Content hash: sha256:65522a7378495a00ff6c3376ac50ff36a48f4352f5334be280dd1311f28bf659
#nullable enable
...
public static partial class GeneratedRemoteEndpoints
{
        ...
        group.MapPost(
            ...
            (HttpContext context) =>
                RemoteServerEngine.ExecuteAsync(
                    ...
                    async () =>
                    {
                        var request = await RemoteServerEngine.ReadRequestAsync<Order_GetByCustomerRequest>(context).ConfigureAwait(false);
        ...
        group.MapPost(
            ...
            (HttpContext context) =>
                RemoteServerEngine.ExecuteAsync(
                    ...
                    async () =>
                    {
                        var request = await RemoteServerEngine.ReadRequestAsync<Order_CountByCustomerRequest>(context).ConfigureAwait(false);
                        var repository = RemoteServerEngine.Repository<IOrderRemoteRepository>(context);
        ...
        group.MapPost(
            ...
            (HttpContext context) =>
                RemoteServerEngine.ExecuteAsync(
                    ...
                    async () =>
                    {
                        var request = await RemoteServerEngine.ReadRequestAsync<Order_SearchMemoRequest>(context).ConfigureAwait(false);
                        var repository = RemoteServerEngine.Repository<IOrderRemoteRepository>(context);
                        return (object?)await repository.SearchMemoAsync(RemoteServerEngine.Required(request.Keyword, "Keyword"), context.RequestAborted).ConfigureAwait(false);
                    }
                )
        );
        ...
        group.MapPost(
            ...
            (HttpContext context) =>
                RemoteServerEngine.ExecuteAsync(
                    ...
                    async () =>
                    {
                        var request = await RemoteServerEngine.ReadRequestAsync<Order_GetByIdsRequest>(context).ConfigureAwait(false);
                        var repository = RemoteServerEngine.Repository<IOrderRemoteRepository>(context);
                        return (object?)await repository.GetByIdsAsync(RemoteServerEngine.Required(request.Ids, "Ids"), context.RequestAborted).ConfigureAwait(false);
                    }
                )
        );
        ...
        group.MapPost(
            ...
            (HttpContext context) =>
                RemoteServerEngine.ExecuteAsync(
                    ...
                    async () =>
                    {
                        var request = await RemoteServerEngine.ReadRequestAsync<Order_GetSummariesRequest>(context).ConfigureAwait(false);
                        var paging = RemoteServerEngine.ValidatedPaging(request.Take, request.Skip);
                        var repository = RemoteServerEngine.Repository<IOrderRemoteRepository>(context);
        ...
        group.MapPost(
            ...
            (HttpContext context) =>
                RemoteServerEngine.ExecuteAsync(
                    ...
                    async () =>
                    {
                        var request = await RemoteServerEngine.ReadRequestAsync<Order_SumAmountsRequest>(context).ConfigureAwait(false);
                        var repository = RemoteServerEngine.Repository<IOrderRemoteRepository>(context);
        ...
        group.MapPost(
            ...
            (HttpContext context) =>
                RemoteServerEngine.ExecuteAsync(
                    ...
                    async () =>
                    {
                        var request = await RemoteServerEngine.ReadRequestAsync<Order_GetByIdsRawRequest>(context).ConfigureAwait(false);
                        var repository = RemoteServerEngine.Repository<IOrderRemoteRepository>(context);
                        return (object?)await repository.GetByIdsRawAsync(RemoteServerEngine.Required(request.Ids, "Ids"), context.RequestAborted).ConfigureAwait(false);
                    }
                )
        );
        ...
        group.MapPost(
            ...
            (HttpContext context) =>
                RemoteServerEngine.ExecuteAsync(
                    ...
                    async () =>
                    {
                        var request = await RemoteServerEngine.ReadRequestAsync<Order_CountByCustomerRawRequest>(context).ConfigureAwait(false);
                        var repository = RemoteServerEngine.Repository<IOrderRemoteRepository>(context);
        ...
        group.MapPost(
            ...
            (HttpContext context) =>
                RemoteServerEngine.ExecuteAsync(
                    ...
                    async () =>
                    {
                        var request = await RemoteServerEngine.ReadRequestAsync<Order_GetMemoRowsRawRequest>(context).ConfigureAwait(false);
                        var repository = RemoteServerEngine.Repository<IOrderRemoteRepository>(context);
        ...
        group.MapPost(
            ...
            (HttpContext context) =>
                RemoteServerEngine.ExecuteAsync(
                    ...
                    async () =>
                    {
                        var request = await RemoteServerEngine.ReadRequestAsync<Order_GetByCustomerTypedRequest>(context).ConfigureAwait(false);
                        var repository = RemoteServerEngine.Repository<IOrderRemoteRepository>(context);
                        return (object?)await repository.GetByCustomerTypedAsync(RemoteServerEngine.Required(request.CustomerId, "CustomerId"), context.RequestAborted).ConfigureAwait(false);
                    }
                )
        );
        ...
        group.MapPost(
            ...
            (HttpContext context) =>
                RemoteServerEngine.ExecuteAsync(
                    ...
                    async () =>
                    {
                        var request = await RemoteServerEngine.ReadRequestAsync<Order_SpecialLookupRequest>(context).ConfigureAwait(false);
                        var repository = RemoteServerEngine.Repository<IOrderRemoteRepository>(context);
    ...
    private sealed record Order_CountByCustomerRequest(int CustomerId);

    /// <summary>Request body for SearchMemo (Order).</summary>
    private sealed record Order_SearchMemoRequest(string Keyword);

    /// <summary>Request body for GetByIds (Order).</summary>
    private sealed record Order_GetByIdsRequest(IReadOnlyList<int> Ids);

    /// <summary>Request body for GetSummaries (Order).</summary>
    private sealed record Order_GetSummariesRequest(int CustomerId, int Take, int Skip);

    /// <summary>Request body for SumAmounts (Order).</summary>
    private sealed record Order_SumAmountsRequest(int CustomerId);

    /// <summary>Request body for GetByIdsRaw (Order).</summary>
    private sealed record Order_GetByIdsRawRequest(IReadOnlyList<int> Ids);

    /// <summary>Request body for CountByCustomerRaw (Order).</summary>
    private sealed record Order_CountByCustomerRawRequest(int CustomerId);

    /// <summary>Request body for GetMemoRowsRaw (Order).</summary>
    private sealed record Order_GetMemoRowsRawRequest(int CustomerId);

    /// <summary>Request body for GetByCustomerTyped (Order).</summary>
    private sealed record Order_GetByCustomerTypedRequest(CustomerIdValue CustomerId);

    /// <summary>Request body for SpecialLookup (Order).</summary>
    private sealed record Order_SpecialLookupRequest(int CustomerId);
    ...
    {
        RemoteServerEngine.MapCrud<NodeEntity, NodeIdValue, INodeRemoteRepository>(
            group,
            "Node"
        );
    }
