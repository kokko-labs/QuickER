...
// Content hash: sha256:71db824941d490dde54a144916d8406ac11bcfddce941ded89b3300dae222740
#nullable enable
        ...
        IValueObject<LineIdValue, int>
{
    ...
    static bool IValueObject<LineIdValue>.TryConvertAbsentInput(IFormatProvider? provider, out LineIdValue? result)
    {
        LineIdValue? absent = null;
    ...
    static partial void ConvertAbsentInput(IFormatProvider? provider, ref LineIdValue? result);
        ...
        IValueObject<QtyValue, int>
{
    ...
    /// <summary>Hands the absent inputs claimed by the ConvertAbsentInput partial hook to TryCreateFrom / CreateFrom, ahead of the ordinary null result.</summary>
    static bool IValueObject<QtyValue>.TryConvertAbsentInput(IFormatProvider? provider, out QtyValue? result)
    {
        QtyValue? absent = null;
        ConvertAbsentInput(provider, ref absent);
        result = absent;
        return absent is not null;
    }
    ...
    /// <summary>Absent input (null, DBNull, or an empty string) for TryCreateFrom / CreateFrom - a flag whose blank cell means a value of its own, say (partial; an absent input falls to a ClaimsAbsent declared instance or the ordinary null result when not implemented). Set result to claim the absent input; leave it null and the call succeeds with a null value object. This hook applies to TryCreateFrom / CreateFrom only - an edit model's blank input and a database NULL are unaffected. Never call TryCreateFrom / CreateFrom from inside (they consult this hook and the call would recurse), and do not throw - TryCreateFrom reports failures through its return value, and an exception here rides straight through that contract.</summary>
    static partial void ConvertAbsentInput(IFormatProvider? provider, ref QtyValue? result);
        ...
        IValueObject<RowVerValue, byte[]>
{
    ...
    /// <summary>Hands the absent inputs claimed by the ConvertAbsentInput partial hook to TryCreateFrom / CreateFrom, ahead of the ordinary null result.</summary>
    static bool IValueObject<RowVerValue>.TryConvertAbsentInput(IFormatProvider? provider, out RowVerValue? result)
    {
        RowVerValue? absent = null;
        ConvertAbsentInput(provider, ref absent);
        result = absent;
        return absent is not null;
    }
    ...
    /// <summary>Absent input (null, DBNull, or an empty string) for TryCreateFrom / CreateFrom - a flag whose blank cell means a value of its own, say (partial; an absent input falls to a ClaimsAbsent declared instance or the ordinary null result when not implemented). Set result to claim the absent input; leave it null and the call succeeds with a null value object. This hook applies to TryCreateFrom / CreateFrom only - an edit model's blank input and a database NULL are unaffected. Never call TryCreateFrom / CreateFrom from inside (they consult this hook and the call would recurse), and do not throw - TryCreateFrom reports failures through its return value, and an exception here rides straight through that contract.</summary>
    static partial void ConvertAbsentInput(IFormatProvider? provider, ref RowVerValue? result);
        ...
        IValueObject<TitleValue, string>
{
    ...
    /// <summary>Hands the absent inputs claimed by the ConvertAbsentInput partial hook to TryCreateFrom / CreateFrom, ahead of the ordinary null result.</summary>
    static bool IValueObject<TitleValue>.TryConvertAbsentInput(IFormatProvider? provider, out TitleValue? result)
    {
        TitleValue? absent = null;
        ConvertAbsentInput(provider, ref absent);
        result = absent;
        return absent is not null;
    }
    ...
    /// <summary>Absent input (null, DBNull, or an empty string) for TryCreateFrom / CreateFrom - a flag whose blank cell means a value of its own, say (partial; an absent input falls to a ClaimsAbsent declared instance or the ordinary null result when not implemented). Set result to claim the absent input; leave it null and the call succeeds with a null value object. This hook applies to TryCreateFrom / CreateFrom only - an edit model's blank input and a database NULL are unaffected. Never call TryCreateFrom / CreateFrom from inside (they consult this hook and the call would recurse), and do not throw - TryCreateFrom reports failures through its return value, and an exception here rides straight through that contract.</summary>
    static partial void ConvertAbsentInput(IFormatProvider? provider, ref TitleValue? result);
