...
// Content hash: sha256:1e471c0cc910cacb9eb4555c6f3950ea64ef5e788abfbbcef909ca3bdaf57b2f
#nullable enable
        ...
        IValueObject<ItemNameValue, string>
{
    ...
    /// <summary>Hands the absent inputs claimed by the ConvertAbsentInput partial hook to TryCreateFrom / CreateFrom, ahead of the ordinary null result.</summary>
    static bool IValueObject<ItemNameValue>.TryConvertAbsentInput(IFormatProvider? provider, out ItemNameValue? result)
    {
        ItemNameValue? absent = null;
        ConvertAbsentInput(provider, ref absent);
        result = absent;
        return absent is not null;
    }
    ...
    /// <summary>Absent input (null, DBNull, or an empty string) for TryCreateFrom / CreateFrom - a flag whose blank cell means a value of its own, say (partial; an absent input falls to a ClaimsAbsent declared instance or the ordinary null result when not implemented). Set result to claim the absent input; leave it null and the call succeeds with a null value object. This hook applies to TryCreateFrom / CreateFrom only - an edit model's blank input and a database NULL are unaffected. Never call TryCreateFrom / CreateFrom from inside (they consult this hook and the call would recurse), and do not throw - TryCreateFrom reports failures through its return value, and an exception here rides straight through that contract.</summary>
    static partial void ConvertAbsentInput(IFormatProvider? provider, ref ItemNameValue? result);

    /// <summary>Gets the display name of this value object (used in error messages and similar). Defaults to the column description, or the property name when unset. Replace it through GeneratedDisplayNames.Resolve, which resolves every generated display name and can switch on the member name.</summary>
    public static string DisplayName =>
        GeneratedDisplayNames.Resolve("ItemName", null);
}
        ...
        IValueObject<NodeIdValue, int>
{
    ...
    /// <summary>Hands the absent inputs claimed by the ConvertAbsentInput partial hook to TryCreateFrom / CreateFrom, ahead of the ordinary null result.</summary>
    static bool IValueObject<NodeIdValue>.TryConvertAbsentInput(IFormatProvider? provider, out NodeIdValue? result)
    {
        NodeIdValue? absent = null;
        ConvertAbsentInput(provider, ref absent);
        result = absent;
        return absent is not null;
    }
    ...
    /// <summary>Absent input (null, DBNull, or an empty string) for TryCreateFrom / CreateFrom - a flag whose blank cell means a value of its own, say (partial; an absent input falls to a ClaimsAbsent declared instance or the ordinary null result when not implemented). Set result to claim the absent input; leave it null and the call succeeds with a null value object. This hook applies to TryCreateFrom / CreateFrom only - an edit model's blank input and a database NULL are unaffected. Never call TryCreateFrom / CreateFrom from inside (they consult this hook and the call would recurse), and do not throw - TryCreateFrom reports failures through its return value, and an exception here rides straight through that contract.</summary>
    static partial void ConvertAbsentInput(IFormatProvider? provider, ref NodeIdValue? result);

    /// <summary>Gets the display name of this value object (used in error messages and similar). Defaults to the column description, or the property name when unset. Replace it through GeneratedDisplayNames.Resolve, which resolves every generated display name and can switch on the member name.</summary>
    public static string DisplayName =>
        GeneratedDisplayNames.Resolve("NodeId", null);
}
        ...
        IValueObject<QuantityValue, int>
{
    ...
    /// <summary>Hands the absent inputs claimed by the ConvertAbsentInput partial hook to TryCreateFrom / CreateFrom, ahead of the ordinary null result.</summary>
    static bool IValueObject<QuantityValue>.TryConvertAbsentInput(IFormatProvider? provider, out QuantityValue? result)
    {
        QuantityValue? absent = null;
        ConvertAbsentInput(provider, ref absent);
        result = absent;
        return absent is not null;
    }
    ...
    /// <summary>Absent input (null, DBNull, or an empty string) for TryCreateFrom / CreateFrom - a flag whose blank cell means a value of its own, say (partial; an absent input falls to a ClaimsAbsent declared instance or the ordinary null result when not implemented). Set result to claim the absent input; leave it null and the call succeeds with a null value object. This hook applies to TryCreateFrom / CreateFrom only - an edit model's blank input and a database NULL are unaffected. Never call TryCreateFrom / CreateFrom from inside (they consult this hook and the call would recurse), and do not throw - TryCreateFrom reports failures through its return value, and an exception here rides straight through that contract.</summary>
    static partial void ConvertAbsentInput(IFormatProvider? provider, ref QuantityValue? result);

    /// <summary>Gets the display name of this value object (used in error messages and similar). Defaults to the column description, or the property name when unset. Replace it through GeneratedDisplayNames.Resolve, which resolves every generated display name and can switch on the member name.</summary>
    public static string DisplayName =>
        GeneratedDisplayNames.Resolve("Quantity", null);
}
...
public partial class OrderEditModel : EditModelBase<OrderEditModel>
{
    ...
    {
        get => GetChildren(_orderLines);
        set => SetChildren(ref _orderLines, value, nameof(OrderLines));
    }
...
public partial class OrderLineEditModel : EditModelBase<OrderLineEditModel>
{
            ...
            switch (ConvertParsedValueObjectInput<LineIdValue, int>(normalized, out var converted, out var rejection))
            {
                ...
                default:
                    SetError(
                        ...
                        EditModelMessages.ParseFailed(nameof(LineId), LineIdValue.DisplayName, normalized, "int")
                    );
                    break;
            }
        }
            ...
            switch (ConvertParsedValueObjectInput<QuantityValue, int>(normalized, out var converted, out var rejection))
            {
                ...
                default:
                    SetError(
                        ...
                        EditModelMessages.ParseFailed(nameof(Quantity), QuantityValue.DisplayName, normalized, "int")
                    );
                    break;
            }
        }
    ...
    /// <summary>The columns of this edit model as data (input of the shared required check, input revert, row-edit snapshot, and duplicate-error mapping).</summary>
    private static readonly IReadOnlyList<EditModelColumn<OrderLineEditModel>> _editModelColumns =
        new EditModelColumn<OrderLineEditModel>[]
        {
            new(
                nameof(LineId),
                nameof(BindingLineId),
                true,
                false,
                static () => LineIdValue.DisplayName,
                static model => model.LineId,
                static (model, value) => model.LineId = (LineIdValue?)value,
                static model => model.LineId?.ToString() ?? string.Empty,
                static (model, input) => model.BindingLineId = input
            ),
            new(
                nameof(OrderId),
                nameof(BindingOrderId),
            ...
            new(
                nameof(ItemName),
                nameof(BindingItemName),
                true,
                false,
                static () => ItemNameValue.DisplayName,
                static model => model.ItemName,
                static (model, value) => model.ItemName = (ItemNameValue?)value,
                static model => model.ItemName?.ToString() ?? string.Empty,
                static (model, input) => model.BindingItemName = input
            ),
            new(
                nameof(Quantity),
                nameof(BindingQuantity),
                true,
                false,
                static () => QuantityValue.DisplayName,
                static model => model.Quantity,
                static (model, value) => model.Quantity = (QuantityValue?)value,
                static model => model.Quantity?.ToString() ?? string.Empty,
                static (model, input) => model.BindingQuantity = input
            ),
        };

    /// <inheritdoc />
    protected override IReadOnlyList<EditModelColumn<OrderLineEditModel>> EditModelColumns =>
        _editModelColumns;
...
public partial class NodeEditModel : EditModelBase<NodeEditModel>
{
            ...
            switch (ConvertParsedValueObjectInput<NodeIdValue, int>(normalized, out var converted, out var rejection))
            {
                ...
                default:
                    SetError(
                        ...
                        EditModelMessages.ParseFailed(nameof(NodeId), NodeIdValue.DisplayName, normalized, "int")
                    );
                    break;
            }
        }
            ...
            switch (ConvertParsedValueObjectInput<NodeIdValue, int>(normalized, out var converted, out var rejection))
            {
                ...
                default:
                    SetError(
                        ...
                        EditModelMessages.ParseFailed(nameof(ParentNodeId), NodeIdValue.DisplayName, normalized, "int")
                    );
                    break;
            }
        }
    ...
    public LabelValue? Label
    {
        ...
        internal set
        {
            if (EqualityComparer<LabelValue?>.Default.Equals(_label, value))
            {
                return;
            }
    ...
    partial void OnLabelChanging(LabelValue? value);
    ...
    partial void OnLabelChanging(LabelValue? oldValue, LabelValue? newValue);
    ...
    partial void OnLabelChanged(LabelValue? value);
    ...
    partial void OnLabelChanged(LabelValue? oldValue, LabelValue? newValue);
    ...
    public string BindingLabel
    {
        ...
        set
        {
            ...
            if (ConvertValueObjectInput<LabelValue>(normalized, out var converted, out var rejection) == BindingConversion.Converted)
            {
                Label = converted;
            ...
            {
                SetError(nameof(BindingLabel), rejection);
            }
        }
    }
    ...
    {
        get => GetChildren(_nodes);
        set => SetChildren(ref _nodes, value, nameof(Nodes));
    }

    /// <summary>The columns of this edit model as data (input of the shared required check, input revert, row-edit snapshot, and duplicate-error mapping).</summary>
    private static readonly IReadOnlyList<EditModelColumn<NodeEditModel>> _editModelColumns =
        new EditModelColumn<NodeEditModel>[]
        {
            new(
                nameof(NodeId),
                nameof(BindingNodeId),
                true,
                false,
                static () => NodeIdValue.DisplayName,
                static model => model.NodeId,
                static (model, value) => model.NodeId = (NodeIdValue?)value,
                static model => model.NodeId?.ToString() ?? string.Empty,
                static (model, input) => model.BindingNodeId = input
            ),
            new(
                nameof(ParentNodeId),
                nameof(BindingParentNodeId),
                ...
                false,
                static () => NodeIdValue.DisplayName,
                static model => model.ParentNodeId,
                static (model, value) => model.ParentNodeId = (NodeIdValue?)value,
                static model => model.ParentNodeId?.ToString() ?? string.Empty,
                static (model, input) => model.BindingParentNodeId = input
            ),
            new(
                nameof(Label),
                nameof(BindingLabel),
    ...
    /// <inheritdoc />
    protected override IReadOnlyList<EditModelColumn<NodeEditModel>> EditModelColumns =>
        _editModelColumns;
...
{
    /// <inheritdoc />
    protected override void AfterEntityCreated(OrderLineEntity entity) =>
        OnEntityCreated(entity);
    ...
    /// <inheritdoc />
    protected override void AfterEditModelCreated(OrderLineEditModel editModel) =>
        OnEditModelCreated(editModel);
    ...
    {
        entity.LineId = Required(editModel.LineId, nameof(editModel.LineId));

        // A removed row takes part in the save through its key alone, so an absent value is skipped instead of enforced.
        if (!editModel.IsRemoved || editModel.OrderId is not null)
        {
            entity.OrderId = Required(editModel.OrderId, nameof(editModel.OrderId));
        }

        // A removed row takes part in the save through its key alone, so an absent value is skipped instead of enforced.
        if (!editModel.IsRemoved || editModel.ItemName is not null)
        {
            entity.ItemName = Required(editModel.ItemName, nameof(editModel.ItemName));
        }

        // A removed row takes part in the save through its key alone, so an absent value is skipped instead of enforced.
        if (!editModel.IsRemoved || editModel.Quantity is not null)
        {
            entity.Quantity = Required(editModel.Quantity, nameof(editModel.Quantity));
        }
    ...
    /// <inheritdoc />
    protected override void LoadColumns(OrderLineEntity entity, OrderLineEditModel editModel)
    {
    ...
    /// <inheritdoc />
    protected override void CompleteLoad(OrderLineEntity entity, OrderLineEditModel editModel)
    {
        OnEditModelLoaded(entity, editModel);
    }
...
{
    /// <inheritdoc />
    protected override void AfterEntityCreated(NodeEntity entity) =>
        OnEntityCreated(entity);
    ...
    /// <inheritdoc />
    protected override void AfterEditModelCreated(NodeEditModel editModel) =>
        OnEditModelCreated(editModel);
    ...
    {
        entity.NodeId = Required(editModel.NodeId, nameof(editModel.NodeId));
        entity.ParentNodeId = editModel.ParentNodeId;

        // A removed row takes part in the save through its key alone, so an absent value is skipped instead of enforced.
        if (!editModel.IsRemoved || editModel.Label is not null)
        {
    ...
    /// <inheritdoc />
    protected override void LoadColumns(NodeEntity entity, NodeEditModel editModel)
    {
    ...
    /// <inheritdoc />
    protected override void CompleteLoad(NodeEntity entity, NodeEditModel editModel)
    {
...
public static class GeneratedSqliteRepositoryServiceCollectionExtensions
{
    ...
    )
    {
        ...
        AddRepository<IOrderLineRepository>(
            (factory, hooks, executor) => new OrderLineRepository(factory, hooks, executor)
        );
        AddRepository<INodeRepository>(
            (factory, hooks, executor) => new NodeRepository(factory, hooks, executor)
        );
...
internal static class OrderUniquenessConstraints
{
    ...
    public static readonly UniquenessConstraintSet<OrderEntity> Set =
...
) : SqliteRepository<OrderEntity, OrderIdValue>(connectionFactory, saveHooks, sqlExecutor), IOrderRepository
{
    ...
    /// <summary>The projection selector of GetSummariesAsync, hoisted into a field so that every call hands the same expression tree instance to the executor (which compiles it once).</summary>
    ...
    public Task<IReadOnlyList<OrderSummaryRow>> GetSummariesAsync(int customerId, int take, int skip = 0, CancellationToken cancellationToken = default) =>
        Query().Where(e => e.CustomerId == CustomerIdValue.Create(customerId)).OrderByDescending(e => e.OrderId).Skip(skip).Take(take).ToProjectionListAsync(_getSummariesAsyncSelector, cancellationToken);
    ...
    /// <inheritdoc />
    protected override UniquenessConstraintSet<OrderEntity> UniquenessConstraints =>
        OrderUniquenessConstraints.Set;
...
public sealed partial class OrderLineRepository(
    ...
    ISaveHookRegistry? saveHooks = null,
    ISqlExecutor? sqlExecutor = null
) : SqliteRepository<OrderLineEntity, LineIdValue>(connectionFactory, saveHooks, sqlExecutor), IOrderLineRepository
{
    /// <inheritdoc />
    protected override void CollectUniquenessChecks(
...
public sealed partial class NodeRepository(
    ...
    ISaveHookRegistry? saveHooks = null,
    ISqlExecutor? sqlExecutor = null
) : SqliteRepository<NodeEntity, NodeIdValue>(connectionFactory, saveHooks, sqlExecutor), INodeRepository
{
    /// <inheritdoc />
    protected override void CollectUniquenessChecks(
...
internal sealed record InMemoryUniqueConstraint(
    string Name,
    IReadOnlyList<PropertyInfo> Properties
);
...
/// </para>
/// </remarks>
internal static class InMemoryUniqueness
{
    private static readonly ConcurrentDictionary<
        Type,
    ...
    where TEntity : EntityBaseCore, new()
{
    ...
    /// would serialize every read in the process behind one query's compilation. Equality over <c>byte[]</c> is rewritten
    /// to a byte-wise comparison first (see <see cref="ByteArrayEqualityRewriter"/>).
    /// </remarks>
    private static Func<TEntity, bool>[] CompilePredicates(SqlQueryPlan<TEntity> plan) =>
        plan.Predicates.Select(predicate =>
                (Func<TEntity, bool>)
                    ((LambdaExpression)ByteArrayEqualityRewriter.Instance.Visit(predicate)).Compile()
            )
            .ToArray();

    /// <summary>Compares two byte arrays by value (two nulls are equal; one null never matches).</summary>
    /// <remarks>
    /// Same semantics as the binary value object's equality: the SQL backends compare the column's actual bytes,
    /// so a null against a value never matches and two equal blobs always do.
    /// </remarks>
    private static bool AreBytesEqual(byte[]? left, byte[]? right) =>
        left is null ? right is null : right is not null && left.AsSpan().SequenceEqual(right);

    /// <summary>The <see cref="AreBytesEqual"/> method, resolved once for the rewriter.</summary>
    private static readonly MethodInfo AreBytesEqualMethod = typeof(InMemoryQueryExecutor<TEntity>).GetMethod(
        nameof(AreBytesEqual),
        BindingFlags.NonPublic | BindingFlags.Static
    )!;

    /// <summary>
    /// Rewrites <c>==</c> / <c>!=</c> over <c>byte[]</c> operands into a byte-wise comparison before the predicate
    /// is compiled.
    /// </summary>
    /// <remarks>
    /// C#'s <c>==</c> on arrays is reference equality, so a compiled predicate would treat two equal blobs as
    /// different - the SQL backends compare the column's actual bytes, and the in-memory store hands out cloned
    /// arrays by design, which makes reference equality never match. Value-object columns are unaffected (their
    /// operators already compare by value), and other operand types keep their C# semantics untouched.
    /// </remarks>
    private sealed class ByteArrayEqualityRewriter : ExpressionVisitor
    {
        /// <summary>The shared stateless instance.</summary>
        public static readonly ByteArrayEqualityRewriter Instance = new();
        ...
        protected override Expression VisitBinary(BinaryExpression node)
        {
            if (
                ...
                && node.Left.Type == typeof(byte[])
                && node.Right.Type == typeof(byte[])
            )
            {
                var call = Expression.Call(AreBytesEqualMethod, Visit(node.Left), Visit(node.Right));
...
/// <summary>In-memory implementation of the repository for OrderLineEntity.</summary>
public sealed partial class InMemoryOrderLineRepository(
    InMemoryDataStore store,
    ISaveHookRegistry? saveHooks = null
) : InMemoryRepository<OrderLineEntity, LineIdValue>(store, saveHooks), IOrderLineRepository
{
    /// <inheritdoc />
    protected override void CollectUniquenessChecks(
        ref List<UniquenessCheck<OrderLineEntity>>? checks
...
public sealed partial class InMemoryNodeRepository(
    InMemoryDataStore store,
    ISaveHookRegistry? saveHooks = null
) : InMemoryRepository<NodeEntity, NodeIdValue>(store, saveHooks), INodeRepository
{
    /// <inheritdoc />
    protected override void CollectUniquenessChecks(
        ref List<UniquenessCheck<NodeEntity>>? checks
...
public static class InMemorySampleData
{
    ...
    /// <summary>Seeds sample data for order_lines.</summary>
    private static void SeedOrderLineEntity(InMemoryDataStore store)
    {
        for (var index = 1; index <= RowsPerEntity; index++)
        {
            var entity = new OrderLineEntity
            {
                LineId = CreateSampleValue<LineIdValue, int>("OrderLineEntity.LineId", index),
                OrderId = CreateSampleValue<OrderIdValue, int>("OrderLineEntity.OrderId", index),
                ItemName = CreateSampleValue<ItemNameValue, string>("OrderLineEntity.ItemName", ($"item_name {index}").Length > 50 ? ($"item_name {index}")[..50] : ($"item_name {index}")),
                Quantity = CreateSampleValue<QuantityValue, int>("OrderLineEntity.Quantity", index * 10),
            };
            entity.MarkAdded();
            store.Put(entity);
            entity.MarkUnchanged();
    ...
    private static void SeedNodeEntity(InMemoryDataStore store)
    {
        for (var index = 1; index <= RowsPerEntity; index++)
        {
            var entity = new NodeEntity
            {
                NodeId = CreateSampleValue<NodeIdValue, int>("NodeEntity.NodeId", index),
                ParentNodeId = index == 3 ? null : CreateSampleValue<NodeIdValue, int>("NodeEntity.ParentNodeId", index),
                Label = CreateSampleValue<LabelValue, string>("NodeEntity.Label", ($"label {index}").Length > 50 ? ($"label {index}")[..50] : ($"label {index}")),
            };
            entity.MarkAdded();
            store.Put(entity);
            entity.MarkUnchanged();
...
public static class GeneratedInMemoryRepositoryServiceCollectionExtensions
{
    ...
    /// <remarks>
    /// There is no keyed overload: keyed registration exists so that one process can write to several databases through
    /// the same contracts, which is a multi-target concern of the dialect-specific extensions.
    /// </remarks>
    ...
    )
    {
        ...
        services.AddScoped<IOrderLineRepository, InMemoryOrderLineRepository>();
...
public partial class QuickErDbContext : DbContext
{
    ...
    /// <summary>DbSet for OrderLineEntity.</summary>
    public DbSet<OrderLineEntity> OrderLines => Set<OrderLineEntity>();

    /// <summary>DbSet for NodeEntity.</summary>
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<OrderLineEntity>(entity =>
        {
            ...
            entity.Ignore(e => e.IsRemoved);
            entity.Ignore(e => e.HasChanges);
            entity.Property(e => e.LineId).HasColumnName("line_id").IsRequired().HasConversion(v => v!.Value, v => LineIdValue.Create(v!));
            entity.Property(e => e.OrderId).HasColumnName("order_id").IsRequired().HasConversion(v => v!.Value, v => OrderIdValue.Create(v!));
            entity.Property(e => e.ItemName).HasColumnName("item_name").IsRequired().HasConversion(v => v!.Value, v => ItemNameValue.Create(v!));
            entity.Property(e => e.Quantity).HasColumnName("quantity").IsRequired().HasConversion(v => v!.Value, v => QuantityValue.Create(v!));
        });
        ...
        modelBuilder.Entity<NodeEntity>(entity =>
        {
            ...
            entity.Ignore(e => e.IsRemoved);
            entity.Ignore(e => e.HasChanges);
            entity.Property(e => e.NodeId).HasColumnName("node_id").IsRequired().HasConversion(v => v!.Value, v => NodeIdValue.Create(v!));
            entity.Property(e => e.ParentNodeId).HasColumnName("parent_node_id").HasConversion(v => v!.Value, v => NodeIdValue.Create(v!));
            entity.Property(e => e.Label).HasColumnName("label").IsRequired().HasConversion(v => v!.Value, v => LabelValue.Create(v!));
            entity
                .HasMany(e => e.Nodes)
                .WithOne()
...
public static class GeneratedEfCoreRepositoryServiceCollectionExtensions
{
    ...
    )
    {
        ...
        services.AddScoped<IOrderLineRepository, EfCoreOrderLineRepository>();
        services.AddScoped<INodeRepository, EfCoreNodeRepository>();
...
/// <summary>EF Core implementation of the repository for OrderLineEntity.</summary>
public sealed partial class EfCoreOrderLineRepository(
    IDbContextFactory<QuickErDbContext> contextFactory,
    ISaveHookRegistry? saveHooks = null,
    ISqlExecutor? sqlExecutor = null
) : EfCoreRepository<OrderLineEntity, LineIdValue, QuickErDbContext>(contextFactory, saveHooks, sqlExecutor), IOrderLineRepository
{
    /// <inheritdoc />
    protected override void CollectUniquenessChecks(
        ref List<UniquenessCheck<OrderLineEntity>>? checks
...
/// <summary>EF Core implementation of the repository for NodeEntity.</summary>
public sealed partial class EfCoreNodeRepository(
    IDbContextFactory<QuickErDbContext> contextFactory,
    ISaveHookRegistry? saveHooks = null,
    ISqlExecutor? sqlExecutor = null
) : EfCoreRepository<NodeEntity, NodeIdValue, QuickErDbContext>(contextFactory, saveHooks, sqlExecutor), INodeRepository
{
    /// <inheritdoc />
    protected override void CollectUniquenessChecks(
        ref List<UniquenessCheck<NodeEntity>>? checks
