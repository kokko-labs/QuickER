...
// Content hash: sha256:366fb14695c19dc591a89bfe012673e2edf1c6cc903d4cc9d3d5607eb2146615
#nullable enable
...
{
    /// <summary>Includes the cascade graph of SyncItemEntity (it has no child-direction navigation, so the query is returned unchanged).</summary>
    public static SqlQuery<SyncItemEntity> IncludeGraph(this SqlQuery<SyncItemEntity> query) => query;
    ...
    public static Task<SyncItemEntity?> GetByIdAsync(
        this SqlQuery<SyncItemEntity> query,
        int id,
        CancellationToken cancellationToken = default
    ...
    public static Task<SyncItemEntity?> GetByIdAsync<TProperty>(
        this IncludableSqlQuery<SyncItemEntity, TProperty> query,
        int id,
        CancellationToken cancellationToken = default
    ) => query.Where(entity => entity.ItemId == id).FirstOrDefaultAsync(cancellationToken);
}
...
public static class GeneratedSqlServerRepositoryServiceCollectionExtensions
{
    ...
    )
    {
        ...
        AddRepository<ISyncItemRepository>(
            (factory, hooks, executor) => new SyncItemRepository(factory, hooks, executor)
        );
