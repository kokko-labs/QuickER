...
// Content hash: sha256:4de1833b1f01e61c25965ec2c5c9073dba7a5d132f07bb89018523ad594cd72b
#nullable enable
...
public partial class OrderLineEditModel : EditModelBase<OrderLineEditModel>
{
    ...
    /// <param name="cancellationToken">The cancellation token.</param>
    public Task<bool> ValidateUniqueAsync(
        IOrderLineRemoteRepository repository,
        CancellationToken cancellationToken = default
    )
    {
        // Only the columns the check reads are copied: the primary key (to exclude this row) and the constraint members.
...
public partial class NodeEditModel : EditModelBase<NodeEditModel>
{
    ...
    /// <param name="cancellationToken">The cancellation token.</param>
    public Task<bool> ValidateUniqueAsync(
        INodeRemoteRepository repository,
        CancellationToken cancellationToken = default
    )
    {
        // Only the columns the check reads are copied: the primary key (to exclude this row) and the constraint members.
    ...
    where TEntity : EntityBaseCore, new()
{
    ...
    )
    {
        ...
        try
        {
            ...
            when (parseError is JsonException or NotSupportedException or ValueObjectValidationException)
        {
...
public static class GeneratedSqliteRepositoryServiceCollectionExtensions
{
    ...
    )
    {
        ...
        AddRepository<INodeRepository, INodeRemoteRepository, NodeRepository>();
    ...
    )
    {
        ...
        AddRepository<INodeRepository, INodeRemoteRepository>(
...
public partial interface IOrderLineRemoteRepository : IRemoteRepository<OrderLineEntity, LineIdValue> { }
...
public partial interface IOrderLineRepository
    : IOrderLineRemoteRepository,
        IRepository<OrderLineEntity, LineIdValue> { }
...
/// <summary>Remote surface of the NodeEntity repository (only CRUD, save, and named queries that can cross a network boundary; swappable for a remote implementation later).</summary>
public partial interface INodeRemoteRepository : IRemoteRepository<NodeEntity, NodeIdValue> { }

/// <summary>Repository interface for NodeEntity (the full-featured surface = the remote surface plus expression-tree queries, raw SQL, and bulk insert).</summary>
public partial interface INodeRepository
    : INodeRemoteRepository,
        IRepository<NodeEntity, NodeIdValue> { }
    ...
    : HttpRemoteRepository<OrderEntity, OrderIdValue>(httpClient, "Order"), IOrderRemoteRepository
{
    ...
    /// <summary>最新（注文IDが最大）の注文を 1 件取得する</summary>
    public Task<OrderEntity?> FindTopAsync(CancellationToken cancellationToken = default) =>
        InvokeNullableAsync<OrderEntity?>("FindTop", null, cancellationToken);
    ...
    /// <summary>顧客IDに紐づく注文金額の合計を取得する（自由 SQL・SQLite）</summary>
    public Task<decimal?> SumAmountsAsync(int customerId, CancellationToken cancellationToken = default) =>
        InvokeNullableAsync<decimal?>("SumAmounts", new { customerId }, cancellationToken);
    ...
    public Task<OrderEntity?> FindTopRawAsync(CancellationToken cancellationToken = default) =>
        InvokeNullableAsync<OrderEntity?>("FindTopRaw", null, cancellationToken);
    ...
    public Task<OrderEntity?> SpecialLookupAsync(int customerId, CancellationToken cancellationToken = default) =>
        InvokeNullableAsync<OrderEntity?>("SpecialLookup", new { customerId }, cancellationToken);
}
...
public sealed partial class HttpOrderLineRemoteRepository(HttpClient httpClient)
    : HttpRemoteRepository<OrderLineEntity, LineIdValue>(httpClient, "OrderLine"), IOrderLineRemoteRepository { }

/// <summary>HTTP client implementation of the remote surface (INodeRemoteRepository) for NodeEntity.</summary>
/// <remarks>Calls the server-side <c>MapGeneratedRemoteEndpoints</c> endpoints. The HttpClient's BaseAddress must include the prefix (default /quicker/).</remarks>
public sealed partial class HttpNodeRemoteRepository(HttpClient httpClient)
    : HttpRemoteRepository<NodeEntity, NodeIdValue>(httpClient, "Node"), INodeRemoteRepository { }
...
public static class GeneratedHttpRemoteRepositoryServiceCollectionExtensions
{
    ...
    )
    {
        ...
        AddClient<INodeRemoteRepository>(client => new HttpNodeRemoteRepository(client));
...
public static class GeneratedEfCoreRepositoryServiceCollectionExtensions
{
    ...
    )
    {
        ...
        AddRepository<ICustomerRepository, ICustomerRemoteRepository, EfCoreCustomerRepository>();
        AddRepository<IOrderRepository, IOrderRemoteRepository, EfCoreOrderRepository>();
        AddRepository<IOrderLineRepository, IOrderLineRemoteRepository, EfCoreOrderLineRepository>();
        AddRepository<INodeRepository, INodeRemoteRepository, EfCoreNodeRepository>();
