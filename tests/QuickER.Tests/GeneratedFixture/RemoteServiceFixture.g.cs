        ...
        IValueObject<ItemNameValue, string>
{
    ...
    /// <summary>Hands the input shapes claimed by the CreateFromCustom partial hook to TryCreateFrom / CreateFrom, ahead of the ordinary conversion.</summary>
    static bool IValueObject<ItemNameValue>.TryCreateFromCustom(object raw, IFormatProvider? provider, out ItemNameValue? result)
    {
    ...
    /// <summary>Custom input shape for TryCreateFrom / CreateFrom - a name for an enumeration-like value object, say (partial; only the ordinary conversion applies when not implemented). Set result to claim the value; leave it null for anything not handled so the ordinary conversion runs. Never call TryCreateFrom / CreateFrom from inside: they consult this hook and the call would recurse.</summary>
    static partial void CreateFromCustom(object raw, IFormatProvider? provider, ref ItemNameValue? result);
        ...
        IValueObject<LineIdValue, int>
{
    ...
    /// <summary>Hands the input shapes claimed by the CreateFromCustom partial hook to TryCreateFrom / CreateFrom, ahead of the ordinary conversion.</summary>
    static bool IValueObject<LineIdValue>.TryCreateFromCustom(object raw, IFormatProvider? provider, out LineIdValue? result)
    {
    ...
    /// <summary>Custom input shape for TryCreateFrom / CreateFrom - a name for an enumeration-like value object, say (partial; only the ordinary conversion applies when not implemented). Set result to claim the value; leave it null for anything not handled so the ordinary conversion runs. Never call TryCreateFrom / CreateFrom from inside: they consult this hook and the call would recurse.</summary>
    static partial void CreateFromCustom(object raw, IFormatProvider? provider, ref LineIdValue? result);
        ...
        IValueObject<NodeIdValue, int>
{
    ...
    /// <summary>Hands the input shapes claimed by the CreateFromCustom partial hook to TryCreateFrom / CreateFrom, ahead of the ordinary conversion.</summary>
    static bool IValueObject<NodeIdValue>.TryCreateFromCustom(object raw, IFormatProvider? provider, out NodeIdValue? result)
    {
    ...
    /// <summary>Custom input shape for TryCreateFrom / CreateFrom - a name for an enumeration-like value object, say (partial; only the ordinary conversion applies when not implemented). Set result to claim the value; leave it null for anything not handled so the ordinary conversion runs. Never call TryCreateFrom / CreateFrom from inside: they consult this hook and the call would recurse.</summary>
    static partial void CreateFromCustom(object raw, IFormatProvider? provider, ref NodeIdValue? result);
        ...
        IValueObject<QuantityValue, int>
{
    ...
    /// <summary>Hands the input shapes claimed by the CreateFromCustom partial hook to TryCreateFrom / CreateFrom, ahead of the ordinary conversion.</summary>
    static bool IValueObject<QuantityValue>.TryCreateFromCustom(object raw, IFormatProvider? provider, out QuantityValue? result)
    {
    ...
    /// <summary>Custom input shape for TryCreateFrom / CreateFrom - a name for an enumeration-like value object, say (partial; only the ordinary conversion applies when not implemented). Set result to claim the value; leave it null for anything not handled so the ordinary conversion runs. Never call TryCreateFrom / CreateFrom from inside: they consult this hook and the call would recurse.</summary>
    static partial void CreateFromCustom(object raw, IFormatProvider? provider, ref QuantityValue? result);
...
public static class GeneratedSqliteRepositoryServiceCollectionExtensions
{
    ...
    )
    {
        ...
        services.AddScoped<INodeRemoteRepository>(provider =>
            provider.GetRequiredService<INodeRepository>()
        );
    ...
    )
    {
        ...
        services.AddKeyedScoped<INodeRemoteRepository>(
            serviceKey,
            (provider, key) => provider.GetRequiredKeyedService<INodeRepository>(key)
        );
...
{
    /// <summary>Checks the UNIQUE constraints of nodes against the database and returns the violations (an empty list when there are none). The check, including any user-defined hooks, runs in the server-side repository.</summary>
    public Task<IReadOnlyList<UniquenessViolation>> CheckUniquenessAsync(NodeEntity entity, CancellationToken cancellationToken = default) =>
        InvokeAsync<IReadOnlyList<UniquenessViolation>>("CheckUniqueness", new { entity }, cancellationToken);
}
...
public static class GeneratedHttpRemoteRepositoryServiceCollectionExtensions
{
    ...
    )
    {
        ...
        services.AddScoped<INodeRemoteRepository>(provider => new HttpNodeRemoteRepository(
            httpClientFactory(provider)
        ));
    ...
    )
    {
        ...
        services.AddKeyedScoped<INodeRemoteRepository>(
            serviceKey,
            (provider, _) => new HttpNodeRemoteRepository(httpClientFactory(provider))
        );
...
public static class GeneratedEfCoreRepositoryServiceCollectionExtensions
{
    ...
    )
    {
        ...
        services.AddScoped<IOrderLineRepository>(provider => new EfCoreOrderLineRepository(
            provider.GetRequiredService<IDbContextFactory<QuickErDbContext>>(),
            provider.GetService<ISaveHookRegistry>(),
            provider.GetService<ISqlExecutor>()
        ));
        ...
        services.AddScoped<INodeRepository>(provider => new EfCoreNodeRepository(
            provider.GetRequiredService<IDbContextFactory<QuickErDbContext>>(),
            provider.GetService<ISaveHookRegistry>(),
            provider.GetService<ISqlExecutor>()
        ));
