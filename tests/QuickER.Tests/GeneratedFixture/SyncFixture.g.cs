...
public sealed class SyncEngine
{
    ...
    )
    {
        ...
        var latestByRow = new Dictionary<string, SyncJournalRow>(StringComparer.Ordinal);
        var idsByRow = new Dictionary<string, List<long>>(StringComparer.Ordinal);
    ...
    private static async Task<(int Uploaded, int Discarded)> ReplayAsync(
        ISyncTable table,
        Dictionary<string, SyncJournalRow> latestByRow,
        Dictionary<string, List<long>> idsByRow,
