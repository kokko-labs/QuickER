...
// Content hash: sha256:97ef3c9771ad8cdafc3d6c65b56221a94c9325847f3d34dbcf0378f12e6a8302
#nullable enable
...
/// <summary>Entity for the blank_probes table</summary>
[Table("blank_probes")]
public partial class BlankProbeEntity : EntityBase
{
    ...
    /// <summary>Property for the flag column</summary>
    [Column("flag")]
    [SqlColumnType(SqlDbType.Bit)]
    [DbColumnMeta("boolean")]
    public bool? Flag { get; set; }

    /// <summary>Property for the seen_at column</summary>
    [Column("seen_at")]
    [SqlColumnType(SqlDbType.DateTime2)]
    [DbColumnMeta("datetime")]
    public DateTime? SeenAt { get; set; }

    /// <summary>Property for the chunk column</summary>
    [Column("chunk")]
    [SqlColumnType(SqlDbType.VarBinary, Size = 16)]
    [DbColumnMeta("binary(16)")]
    public byte[]? Chunk { get; set; }

    /// <summary>Property for the rate column</summary>
    [Column("rate")]
    [SqlColumnType(SqlDbType.Decimal, Precision = 10, Scale = 2)]
    [DbColumnMeta("decimal(10,2)")]
    public decimal? Rate { get; set; }

    /// <summary>Property for the logged_at column</summary>
    [Column("logged_at")]
    [SqlColumnType(SqlDbType.DateTime2)]
    [DbColumnMeta("datetime")]
    public DateTime LoggedAt { get; set; }

    /// <summary>Property for the stamp column</summary>
    [Column("stamp")]
    [Required]
    [SqlColumnType(SqlDbType.Binary, Size = 8)]
    [DbColumnMeta("fixedbinary(8)")]
...
public partial class CustomerEditModel : EditModelBase<CustomerEditModel>
{
    ...
    public string BindingBalance
    {
        ...
        set
        {
            ...
            if (ConvertParsedInput<decimal>(normalized, out var parsed) == BindingConversion.Converted)
            {
                Balance = parsed;
            ...
            else
            {
                SetError(
                    ...
                    EditModelMessages.ParseFailed(nameof(Balance), GetDisplayName(nameof(Balance), null), normalized, "decimal")
                );
            }
        }
    }
    ...
    private static readonly IReadOnlyList<EditModelColumn<CustomerEditModel>> _editModelColumns =
        new EditModelColumn<CustomerEditModel>[]
        {
            new(
                ...
                true,
                false,
                static () => GetDisplayName(nameof(CustomerId), null),
                static model => model.CustomerId,
                static (model, value) => model.CustomerId = (int?)value,
            ...
            new(
                ...
                true,
                false,
                static () => GetDisplayName(nameof(Name), null),
                static model => model.Name,
                static (model, value) => model.Name = (string?)value,
            ...
            new(
                ...
                false,
                false,
                static () => GetDisplayName(nameof(Balance), null),
                static model => model.Balance,
                static (model, value) => model.Balance = (decimal?)value,
    ...
    private static readonly IReadOnlyList<EditModelColumn<OrderEditModel>> _editModelColumns =
        new EditModelColumn<OrderEditModel>[]
        {
            new(
                ...
                true,
                false,
                static () => GetDisplayName(nameof(OrderId), null),
                static model => model.OrderId,
                static (model, value) => model.OrderId = (int?)value,
            ...
            new(
                ...
                false,
                false,
                static () => GetDisplayName(nameof(Memo), null),
                static model => model.Memo,
                static (model, value) => model.Memo = (string?)value,
            ...
            new(
                ...
                true,
                false,
                static () => GetDisplayName(nameof(Amount), null),
                static model => model.Amount,
                static (model, value) => model.Amount = (decimal?)value,
...
public partial class CustomerProfileEditModel : EditModelBase<CustomerProfileEditModel>
{
        ...
        set
        {
            ...
            else
            {
                SetError(
                    ...
                    EditModelMessages.ParseFailed(nameof(ProfileId), GetDisplayName(nameof(ProfileId), null), normalized, "int")
                );
            }
        }
    }
    ...
    public string BindingBio
    {
        ...
        set
        {
            ...
            Bio = string.IsNullOrEmpty(normalized) ? null : normalized;
    ...
    private static readonly IReadOnlyList<EditModelColumn<CustomerProfileEditModel>> _editModelColumns =
        new EditModelColumn<CustomerProfileEditModel>[]
        {
            new(
                ...
                true,
                false,
                static () => GetDisplayName(nameof(ProfileId), null),
                static model => model.ProfileId,
                static (model, value) => model.ProfileId = (int?)value,
            ...
            new(
                ...
                false,
                false,
                static () => GetDisplayName(nameof(Bio), null),
                static model => model.Bio,
                static (model, value) => model.Bio = (string?)value,
...
/// <summary>Edit model for on-screen editing of the blank_probes table.</summary>
public partial class BlankProbeEditModel : EditModelBase<BlankProbeEditModel>
{
    // Each column keeps two representations: the confirmed value and the on-screen input string (conversion errors are held by the error dictionary).
    /// <summary>Confirmed value of ProbeId.</summary>
    private int? _probeId;

    /// <summary>On-screen input string for ProbeId.</summary>
    private string _bindingProbeId = string.Empty;

    /// <summary>Confirmed value of ProbeId (written by the input conversion and by the mapper when loading; treat it as read-only elsewhere).</summary>
    public int? ProbeId
    {
        get => _probeId;
        internal set
        {
            if (EqualityComparer<int?>.Default.Equals(_probeId, value))
            {
                return;
            }

            var oldValue = _probeId;
            OnProbeIdChanging(value);
            OnProbeIdChanging(oldValue, value);
            _probeId = value;
            OnProbeIdChanged(value);
            OnProbeIdChanged(oldValue, value);
            AfterConfirmedValueSet(nameof(ProbeId));
        }
    }

    /// <summary>Called just before the confirmed value of ProbeId changes (new value only; add processing via a partial implementation).</summary>
    partial void OnProbeIdChanging(int? value);

    /// <summary>Called just before the confirmed value of ProbeId changes (old and new values; add processing via a partial implementation).</summary>
    partial void OnProbeIdChanging(int? oldValue, int? newValue);

    /// <summary>Called just after the confirmed value of ProbeId changes (new value only; add processing via a partial implementation).</summary>
    partial void OnProbeIdChanged(int? value);

    /// <summary>Called just after the confirmed value of ProbeId changes (old and new values; add processing via a partial implementation).</summary>
    partial void OnProbeIdChanged(int? oldValue, int? newValue);

    /// <summary>On-screen input binding string for ProbeId (converted to the confirmed value when set).</summary>
    public string BindingProbeId
    {
        get => _bindingProbeId;
        set
        {
            if (!AcceptBindingInput(ref _bindingProbeId, value, nameof(BindingProbeId), out var normalized))
            {
                return;
            }
            ...
            {
                ProbeId = parsed;
                SetError(nameof(BindingProbeId), null);
            }
            else
            {
                SetError(
                    nameof(BindingProbeId),
                    EditModelMessages.ParseFailed(nameof(ProbeId), GetDisplayName(nameof(ProbeId), null), normalized, "int")
                );
            }
        }
    }

    /// <summary>Confirmed value of Flag.</summary>
    private bool? _flag;

    /// <summary>On-screen input string for Flag.</summary>
    private string _bindingFlag = string.Empty;

    /// <summary>Confirmed value of Flag (written by the input conversion and by the mapper when loading; treat it as read-only elsewhere).</summary>
    public bool? Flag
    {
        get => _flag;
        internal set
        {
            if (EqualityComparer<bool?>.Default.Equals(_flag, value))
            {
                return;
            }
            ...
            OnFlagChanging(oldValue, value);
            _flag = value;
            OnFlagChanged(value);
            OnFlagChanged(oldValue, value);
            AfterConfirmedValueSet(nameof(Flag));
        }
    }

    /// <summary>Called just before the confirmed value of Flag changes (new value only; add processing via a partial implementation).</summary>
    partial void OnFlagChanging(bool? value);

    /// <summary>Called just before the confirmed value of Flag changes (old and new values; add processing via a partial implementation).</summary>
    partial void OnFlagChanging(bool? oldValue, bool? newValue);

    /// <summary>Called just after the confirmed value of Flag changes (new value only; add processing via a partial implementation).</summary>
    partial void OnFlagChanged(bool? value);

    /// <summary>Called just after the confirmed value of Flag changes (old and new values; add processing via a partial implementation).</summary>
    partial void OnFlagChanged(bool? oldValue, bool? newValue);

    /// <summary>On-screen input binding string for Flag (converted to the confirmed value when set).</summary>
    public string BindingFlag
    {
        get => _bindingFlag;
        set
        {
            if (!AcceptBindingInput(ref _bindingFlag, value, nameof(BindingFlag), out var normalized))
            {
                return;
            }
            ...
            {
                Flag = parsed;
                SetError(nameof(BindingFlag), null);
            }
            else
            {
                SetError(
                    nameof(BindingFlag),
                    EditModelMessages.ParseFailed(nameof(Flag), GetDisplayName(nameof(Flag), null), normalized, "bool")
                );
            }
        }
    }

    /// <summary>Confirmed value of SeenAt.</summary>
    private DateTime? _seenAt;

    /// <summary>On-screen input string for SeenAt.</summary>
    private string _bindingSeenAt = string.Empty;

    /// <summary>Confirmed value of SeenAt (written by the input conversion and by the mapper when loading; treat it as read-only elsewhere).</summary>
    public DateTime? SeenAt
    {
        get => _seenAt;
        internal set
        {
            if (EqualityComparer<DateTime?>.Default.Equals(_seenAt, value))
            {
                return;
            }

            var oldValue = _seenAt;
            OnSeenAtChanging(value);
            OnSeenAtChanging(oldValue, value);
            _seenAt = value;
            OnSeenAtChanged(value);
            OnSeenAtChanged(oldValue, value);
            AfterConfirmedValueSet(nameof(SeenAt));
        }
    }

    /// <summary>Called just before the confirmed value of SeenAt changes (new value only; add processing via a partial implementation).</summary>
    partial void OnSeenAtChanging(DateTime? value);

    /// <summary>Called just before the confirmed value of SeenAt changes (old and new values; add processing via a partial implementation).</summary>
    partial void OnSeenAtChanging(DateTime? oldValue, DateTime? newValue);

    /// <summary>Called just after the confirmed value of SeenAt changes (new value only; add processing via a partial implementation).</summary>
    partial void OnSeenAtChanged(DateTime? value);

    /// <summary>Called just after the confirmed value of SeenAt changes (old and new values; add processing via a partial implementation).</summary>
    partial void OnSeenAtChanged(DateTime? oldValue, DateTime? newValue);

    /// <summary>On-screen input binding string for SeenAt (converted to the confirmed value when set).</summary>
    public string BindingSeenAt
    {
        get => _bindingSeenAt;
        set
        {
            if (!AcceptBindingInput(ref _bindingSeenAt, value, nameof(BindingSeenAt), out var normalized))
            {
                return;
            }

            if (ConvertParsedInput<DateTime>(normalized, out var parsed) == BindingConversion.Converted)
            {
                SeenAt = parsed;
                SetError(nameof(BindingSeenAt), null);
            }
            else
            {
                SetError(
                    nameof(BindingSeenAt),
                    EditModelMessages.ParseFailed(nameof(SeenAt), GetDisplayName(nameof(SeenAt), null), normalized, "DateTime")
                );
            }
        }
    }

    /// <summary>Confirmed value of Chunk.</summary>
    private byte[]? _chunk;

    /// <summary>On-screen input string for Chunk.</summary>
    private string _bindingChunk = string.Empty;

    /// <summary>Confirmed value of Chunk (written by the input conversion and by the mapper when loading; treat it as read-only elsewhere).</summary>
    public byte[]? Chunk
    {
        get => _chunk;
        internal set
        {
            if (EqualityComparer<byte[]?>.Default.Equals(_chunk, value))
            {
                return;
            }
            ...
            OnChunkChanging(oldValue, value);
            _chunk = value;
            OnChunkChanged(value);
            OnChunkChanged(oldValue, value);
            AfterConfirmedValueSet(nameof(Chunk));
        }
    }

    /// <summary>Called just before the confirmed value of Chunk changes (new value only; add processing via a partial implementation).</summary>
    partial void OnChunkChanging(byte[]? value);

    /// <summary>Called just before the confirmed value of Chunk changes (old and new values; add processing via a partial implementation).</summary>
    partial void OnChunkChanging(byte[]? oldValue, byte[]? newValue);

    /// <summary>Called just after the confirmed value of Chunk changes (new value only; add processing via a partial implementation).</summary>
    partial void OnChunkChanged(byte[]? value);

    /// <summary>Called just after the confirmed value of Chunk changes (old and new values; add processing via a partial implementation).</summary>
    partial void OnChunkChanged(byte[]? oldValue, byte[]? newValue);

    /// <summary>On-screen input binding string for Chunk (converted to the confirmed value when set).</summary>
    public string BindingChunk
    {
        get => _bindingChunk;
        set
        {
            if (!AcceptBindingInput(ref _bindingChunk, value, nameof(BindingChunk), out var normalized))
            {
                return;
            }
            ...
            {
                Chunk = bytes;
                SetError(nameof(BindingChunk), null);
            }
            else
            {
                SetError(
                    nameof(BindingChunk),
                    EditModelMessages.ParseFailed(nameof(Chunk), GetDisplayName(nameof(Chunk), null), normalized, "byte[]")
                );
            }
        }
    }

    /// <summary>Confirmed value of Rate.</summary>
    private decimal? _rate;

    /// <summary>On-screen input string for Rate.</summary>
    private string _bindingRate = string.Empty;

    /// <summary>Confirmed value of Rate (written by the input conversion and by the mapper when loading; treat it as read-only elsewhere).</summary>
    public decimal? Rate
    {
        get => _rate;
        internal set
        {
            ...
            OnRateChanging(oldValue, value);
            _rate = value;
            OnRateChanged(value);
            OnRateChanged(oldValue, value);
            AfterConfirmedValueSet(nameof(Rate));
        }
    }

    /// <summary>Called just before the confirmed value of Rate changes (new value only; add processing via a partial implementation).</summary>
    partial void OnRateChanging(decimal? value);

    /// <summary>Called just before the confirmed value of Rate changes (old and new values; add processing via a partial implementation).</summary>
    partial void OnRateChanging(decimal? oldValue, decimal? newValue);

    /// <summary>Called just after the confirmed value of Rate changes (new value only; add processing via a partial implementation).</summary>
    partial void OnRateChanged(decimal? value);

    /// <summary>Called just after the confirmed value of Rate changes (old and new values; add processing via a partial implementation).</summary>
    partial void OnRateChanged(decimal? oldValue, decimal? newValue);

    /// <summary>On-screen input binding string for Rate (converted to the confirmed value when set).</summary>
    public string BindingRate
    {
        get => _bindingRate;
        set
        {
            if (!AcceptBindingInput(ref _bindingRate, value, nameof(BindingRate), out var normalized))
            {
                return;
            }
            ...
            {
                Rate = parsed;
                SetError(nameof(BindingRate), null);
            }
            else
            {
                SetError(
                    nameof(BindingRate),
                    EditModelMessages.ParseFailed(nameof(Rate), GetDisplayName(nameof(Rate), null), normalized, "decimal")
                );
            }
        }
    }

    /// <summary>Confirmed value of LoggedAt.</summary>
    private DateTime? _loggedAt;

    /// <summary>On-screen input string for LoggedAt.</summary>
    private string _bindingLoggedAt = string.Empty;

    /// <summary>Confirmed value of LoggedAt (written by the input conversion and by the mapper when loading; treat it as read-only elsewhere).</summary>
    public DateTime? LoggedAt
    {
        get => _loggedAt;
        internal set
        {
            if (EqualityComparer<DateTime?>.Default.Equals(_loggedAt, value))
            {
                return;
            }

            var oldValue = _loggedAt;
            OnLoggedAtChanging(value);
            OnLoggedAtChanging(oldValue, value);
            _loggedAt = value;
            OnLoggedAtChanged(value);
            OnLoggedAtChanged(oldValue, value);
            AfterConfirmedValueSet(nameof(LoggedAt));
        }
    }

    /// <summary>Called just before the confirmed value of LoggedAt changes (new value only; add processing via a partial implementation).</summary>
    partial void OnLoggedAtChanging(DateTime? value);

    /// <summary>Called just before the confirmed value of LoggedAt changes (old and new values; add processing via a partial implementation).</summary>
    partial void OnLoggedAtChanging(DateTime? oldValue, DateTime? newValue);

    /// <summary>Called just after the confirmed value of LoggedAt changes (new value only; add processing via a partial implementation).</summary>
    partial void OnLoggedAtChanged(DateTime? value);

    /// <summary>Called just after the confirmed value of LoggedAt changes (old and new values; add processing via a partial implementation).</summary>
    partial void OnLoggedAtChanged(DateTime? oldValue, DateTime? newValue);

    /// <summary>On-screen input binding string for LoggedAt (converted to the confirmed value when set).</summary>
    public string BindingLoggedAt
    {
        get => _bindingLoggedAt;
        set
        {
            if (!AcceptBindingInput(ref _bindingLoggedAt, value, nameof(BindingLoggedAt), out var normalized))
            {
                return;
            }
            ...
            {
                LoggedAt = parsed;
                SetError(nameof(BindingLoggedAt), null);
            }
            else
            {
                SetError(
                    nameof(BindingLoggedAt),
                    EditModelMessages.ParseFailed(nameof(LoggedAt), GetDisplayName(nameof(LoggedAt), null), normalized, "DateTime")
                );
            }
        }
    }

    /// <summary>Confirmed value of Stamp.</summary>
    private byte[]? _stamp;

    /// <summary>On-screen input string for Stamp.</summary>
    private string _bindingStamp = string.Empty;

    /// <summary>Confirmed value of Stamp (written by the input conversion and by the mapper when loading; treat it as read-only elsewhere).</summary>
    public byte[]? Stamp
    {
        get => _stamp;
        internal set
        {
            if (EqualityComparer<byte[]?>.Default.Equals(_stamp, value))
            {
                return;
            }
            ...
            OnStampChanging(oldValue, value);
            _stamp = value;
            OnStampChanged(value);
            OnStampChanged(oldValue, value);
            AfterConfirmedValueSet(nameof(Stamp));
        }
    }

    /// <summary>Called just before the confirmed value of Stamp changes (new value only; add processing via a partial implementation).</summary>
    partial void OnStampChanging(byte[]? value);

    /// <summary>Called just before the confirmed value of Stamp changes (old and new values; add processing via a partial implementation).</summary>
    partial void OnStampChanging(byte[]? oldValue, byte[]? newValue);

    /// <summary>Called just after the confirmed value of Stamp changes (new value only; add processing via a partial implementation).</summary>
    partial void OnStampChanged(byte[]? value);

    /// <summary>Called just after the confirmed value of Stamp changes (old and new values; add processing via a partial implementation).</summary>
    partial void OnStampChanged(byte[]? oldValue, byte[]? newValue);

    /// <summary>On-screen input binding string for Stamp (converted to the confirmed value when set).</summary>
    public string BindingStamp
    {
        get => _bindingStamp;
        set
        {
            if (!AcceptBindingInput(ref _bindingStamp, value, nameof(BindingStamp), out var normalized))
            {
                return;
            }
            ...
            {
                Stamp = bytes;
                SetError(nameof(BindingStamp), null);
            }
            else
            {
                SetError(
                    nameof(BindingStamp),
                    EditModelMessages.ParseFailed(nameof(Stamp), GetDisplayName(nameof(Stamp), null), normalized, "byte[]")
                );
            }
        }
    }
    ...
    // ---- navigation ----
    /// <summary>The columns of this edit model as data (input of the shared required check, input revert, row-edit snapshot, and duplicate-error mapping).</summary>
    private static readonly IReadOnlyList<EditModelColumn<BlankProbeEditModel>> _editModelColumns =
        new EditModelColumn<BlankProbeEditModel>[]
        {
            new(
                nameof(ProbeId),
                nameof(BindingProbeId),
                true,
                false,
                static () => GetDisplayName(nameof(ProbeId), null),
                static model => model.ProbeId,
                static (model, value) => model.ProbeId = (int?)value,
                static model => model.ProbeId?.ToString() ?? string.Empty,
                static (model, input) => model.BindingProbeId = input
            ),
            new(
                nameof(Flag),
                nameof(BindingFlag),
                false,
                false,
                static () => GetDisplayName(nameof(Flag), null),
                static model => model.Flag,
                static (model, value) => model.Flag = (bool?)value,
                static model => model.Flag?.ToString() ?? string.Empty,
                static (model, input) => model.BindingFlag = input
            ),
            new(
                nameof(SeenAt),
                nameof(BindingSeenAt),
                false,
                false,
                static () => GetDisplayName(nameof(SeenAt), null),
                static model => model.SeenAt,
                static (model, value) => model.SeenAt = (DateTime?)value,
                static model => EditModelInputFormat.Format(model.SeenAt),
                static (model, input) => model.BindingSeenAt = input
            ),
            new(
                nameof(Chunk),
                nameof(BindingChunk),
                false,
                false,
                static () => GetDisplayName(nameof(Chunk), null),
                static model => model.Chunk,
                static (model, value) => model.Chunk = (byte[]?)value,
                static model => model.Chunk is null ? string.Empty : Convert.ToBase64String(model.Chunk),
                static (model, input) => model.BindingChunk = input
            ),
            new(
                nameof(Rate),
                nameof(BindingRate),
                false,
                false,
                static () => GetDisplayName(nameof(Rate), null),
                static model => model.Rate,
                static (model, value) => model.Rate = (decimal?)value,
                static model => model.Rate?.ToString() ?? string.Empty,
                static (model, input) => model.BindingRate = input
            ),
            new(
                nameof(LoggedAt),
                nameof(BindingLoggedAt),
                true,
                false,
                static () => GetDisplayName(nameof(LoggedAt), null),
                static model => model.LoggedAt,
                static (model, value) => model.LoggedAt = (DateTime?)value,
                static model => EditModelInputFormat.Format(model.LoggedAt),
                static (model, input) => model.BindingLoggedAt = input
            ),
            new(
                nameof(Stamp),
                nameof(BindingStamp),
                true,
                false,
                static () => GetDisplayName(nameof(Stamp), null),
                static model => model.Stamp,
                static (model, value) => model.Stamp = (byte[]?)value,
                static model => model.Stamp is null ? string.Empty : Convert.ToBase64String(model.Stamp),
                static (model, input) => model.BindingStamp = input
            ),
        };

    /// <inheritdoc />
    protected override IReadOnlyList<EditModelColumn<BlankProbeEditModel>> EditModelColumns =>
        _editModelColumns;
    ...
    /// <param name="cancellationToken">The cancellation token.</param>
    public Task<bool> ValidateUniqueAsync(
        IBlankProbeRepository repository,
        CancellationToken cancellationToken = default
    )
    {
        // Only the columns the check reads are copied: the primary key (to exclude this row) and the constraint members.
        var entity = new BlankProbeEntity();

        if (ProbeId is { } resolvedProbeId)
        {
            entity.ProbeId = resolvedProbeId;
        }
        ...
        set
        {
            ...
            else
            {
                SetError(
                    ...
                    EditModelMessages.ParseFailed(nameof(NodeId), GetDisplayName(nameof(NodeId), null), normalized, "int")
                );
            }
        }
    }
        ...
        set
        {
            ...
            else
            {
                SetError(
                    ...
                    EditModelMessages.ParseFailed(nameof(ParentNodeId), GetDisplayName(nameof(ParentNodeId), null), normalized, "int")
                );
            }
        }
    }
    ...
    private static readonly IReadOnlyList<EditModelColumn<NodeEditModel>> _editModelColumns =
        new EditModelColumn<NodeEditModel>[]
        {
            new(
                ...
                true,
                false,
                static () => GetDisplayName(nameof(NodeId), null),
                static model => model.NodeId,
                static (model, value) => model.NodeId = (int?)value,
            ...
            new(
                ...
                false,
                false,
                static () => GetDisplayName(nameof(ParentNodeId), null),
                static model => model.ParentNodeId,
                static (model, value) => model.ParentNodeId = (int?)value,
            ...
            new(
                ...
                true,
                false,
                static () => GetDisplayName(nameof(Label), null),
                static model => model.Label,
                static (model, value) => model.Label = (string?)value,
...
/// <summary>Converts between BlankProbeEntity and BlankProbeEditModel.</summary>
public sealed partial class BlankProbeMapper
    : MapperBase<BlankProbeEntity, BlankProbeEditModel>
{
    /// <inheritdoc />
    protected override void AfterEntityCreated(BlankProbeEntity entity) =>
        OnEntityCreated(entity);

    /// <summary>Called just after a new BlankProbeEntity is created (set initial values via a partial implementation).</summary>
    /// <remarks>Every conversion creates a fresh entity, so this also fires when an existing edit model is converted (<c>CreateEntity(editModel, …)</c>), and the RowState at this point is always Added - the edit model's state is transferred later, at the end of the column copy.</remarks>
    partial void OnEntityCreated(BlankProbeEntity entity);

    /// <inheritdoc />
    protected override void AfterEditModelCreated(BlankProbeEditModel editModel) =>
        OnEditModelCreated(editModel);

    /// <summary>Called just after a new BlankProbeEditModel is created (after loading) (set initial values via a partial implementation; branch on IsAdded to target new models only).</summary>
    partial void OnEditModelCreated(BlankProbeEditModel editModel);

    /// <inheritdoc />
    public override void ApplyToEntity(
        BlankProbeEditModel editModel,
        BlankProbeEntity entity,
        bool includeRemoved
    )
    {
        entity.ProbeId = Required(editModel.ProbeId, nameof(editModel.ProbeId));
        entity.Flag = editModel.Flag;
        entity.SeenAt = editModel.SeenAt;
        entity.Chunk = editModel.Chunk;
        entity.Rate = editModel.Rate;

        // A removed row takes part in the save through its key alone, so an absent value is skipped instead of enforced.
        if (!editModel.IsRemoved || editModel.LoggedAt is not null)
        {
            entity.LoggedAt = Required(editModel.LoggedAt, nameof(editModel.LoggedAt));
        }

        // A removed row takes part in the save through its key alone, so an absent value is skipped instead of enforced.
        if (!editModel.IsRemoved || editModel.Stamp is not null)
        {
            entity.Stamp = Required(editModel.Stamp, nameof(editModel.Stamp));
        }
    ...
    /// <summary>Called after the BlankProbeEditModel's confirmed values are applied to the BlankProbeEntity (save additional properties via a partial implementation).</summary>
    partial void OnEntityApplied(BlankProbeEditModel editModel, BlankProbeEntity entity);

    /// <inheritdoc />
    protected override void LoadColumns(BlankProbeEntity entity, BlankProbeEditModel editModel)
    {
        editModel.ProbeId = entity.ProbeId;
        editModel.Flag = entity.Flag;
        editModel.SeenAt = entity.SeenAt;
        editModel.Chunk = (byte[]?)entity.Chunk?.Clone();
        editModel.Rate = entity.Rate;
        editModel.LoggedAt = entity.LoggedAt;
        editModel.Stamp = (byte[]?)entity.Stamp?.Clone();
    }

    /// <inheritdoc />
    protected override void CompleteLoad(BlankProbeEntity entity, BlankProbeEditModel editModel)
    {
        OnEditModelLoaded(entity, editModel);
    }

    /// <summary>Called after the default load into the BlankProbeEditModel (load additional properties via a partial implementation).</summary>
    partial void OnEditModelLoaded(BlankProbeEntity entity, BlankProbeEditModel editModel);
}
...
/// <summary>Repository interface for BlankProbeEntity.</summary>
public partial interface IBlankProbeRepository : IRepository<BlankProbeEntity, int> { }
...
public static class SqlQueryExtensions
{
    ...
    /// <summary>Includes the cascade graph of BlankProbeEntity (it has no child-direction navigation, so the query is returned unchanged).</summary>
    public static SqlQuery<BlankProbeEntity> IncludeGraph(this SqlQuery<BlankProbeEntity> query) => query;

    /// <summary>Fetches the single entity with the given key - the same key the repository contract's GetByIdAsync takes - and returns null when no row matches.</summary>
    /// <remarks>Combine it with Include or IncludeGraph to fetch that entity together with its graph in one call.</remarks>
    public static Task<BlankProbeEntity?> GetByIdAsync(
        this SqlQuery<BlankProbeEntity> query,
        int id,
        CancellationToken cancellationToken = default
    ) => query.Where(entity => entity.ProbeId == id).FirstOrDefaultAsync(cancellationToken);

    /// <summary>Fetches the single entity with the given key, keeping the Include chain written just before it (returns null when no row matches).</summary>
    public static Task<BlankProbeEntity?> GetByIdAsync<TProperty>(
        this IncludableSqlQuery<BlankProbeEntity, TProperty> query,
        int id,
        CancellationToken cancellationToken = default
    ) => query.Where(entity => entity.ProbeId == id).FirstOrDefaultAsync(cancellationToken);
...
) : InMemoryRepository<OrderEntity, int>(store, saveHooks), IOrderRepository
{
    ...
    public Task<IReadOnlyList<OrderSummaryRow>> GetSummariesAsync(int customerId, CancellationToken cancellationToken = default) =>
        Query().Where(e => e.CustomerId == customerId).OrderBy(e => e.OrderId).ToProjectionListAsync(_getSummariesAsyncSelector, cancellationToken);
...
/// <summary>In-memory implementation of the repository for BlankProbeEntity.</summary>
public sealed partial class InMemoryBlankProbeRepository(
    InMemoryDataStore store,
    ISaveHookRegistry? saveHooks = null
) : InMemoryRepository<BlankProbeEntity, int>(store, saveHooks), IBlankProbeRepository
{
    /// <inheritdoc />
    protected override void CollectUniquenessChecks(
        ref List<UniquenessCheck<BlankProbeEntity>>? checks
    ) => CollectCustomUniquenessChecks(ref checks);
...
public static class InMemorySampleData
{
    ...
    /// <summary>Seeds sample data for blank_probes.</summary>
    private static void SeedBlankProbeEntity(InMemoryDataStore store)
    {
        for (var index = 1; index <= RowsPerEntity; index++)
        {
            var entity = new BlankProbeEntity
            {
                ProbeId = index,
                Flag = index == 3 ? null : index % 2 == 1,
                SeenAt = index == 3 ? null : new DateTime(2024, 1, 1, 0, 0, 0, DateTimeKind.Utc).AddDays(index),
                Chunk = index == 3 ? null : new byte[] { (byte)index, (byte)(index + 1), (byte)(index + 2) },
                Rate = index == 3 ? null : index * 100.05m,
                LoggedAt = new DateTime(2024, 1, 1, 0, 0, 0, DateTimeKind.Utc).AddDays(index),
                Stamp = new byte[] { (byte)index, (byte)(index + 1), (byte)(index + 2) },
            };
            entity.MarkAdded();
            store.Put(entity);
            entity.MarkUnchanged();
...
public static class GeneratedInMemoryRepositoryServiceCollectionExtensions
{
    ...
    )
    {
        ...
        services.AddScoped<IBlankProbeRepository, InMemoryBlankProbeRepository>();
