...
// Content hash: sha256:40d0a52051d980178651d78d2a6d6ae4e4fa73598616eaa1dc240aaeddff690b
#nullable enable
...
public partial class DocumentNoteEditModel : EditModelBase<DocumentNoteEditModel>
{
    ...
    /// <param name="cancellationToken">The cancellation token.</param>
    public Task<bool> ValidateUniqueAsync(
        IDocumentNoteRepository repository,
        CancellationToken cancellationToken = default
    )
    {
        // Only the columns the check reads are copied: the primary key (to exclude this row) and the constraint members.
...
public static class GeneratedSqlServerRepositoryServiceCollectionExtensions
{
    ...
    )
    {
        ...
        AddRepository<IDocumentRepository>(
            (factory, hooks, executor) => new DocumentRepository(factory, hooks, executor)
        );
        AddRepository<IDocumentNoteRepository>(
...
/// <summary>Repository interface for DocumentEntity.</summary>
...
/// <summary>Repository interface for DocumentNoteEntity.</summary>
