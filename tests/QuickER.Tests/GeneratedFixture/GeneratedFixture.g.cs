...
public partial class CustomerEditModel : EditModelBase
{
    ...
    protected override void ValidateSelf()
    {
        ...
        if (IsActive is null)
        {
            SetError(nameof(BindingIsActive), ResolveRequiredErrorMessage(nameof(IsActive), IsActiveValue.DisplayName));
        }
        OnValidate();
    }
    ...
    /// <summary>Pre-edit snapshot of IsActive.</summary>
    private string _bindingIsActiveSnapshot = string.Empty;
    ...
    protected override void BeginEditCore()
    {
        ...
        _bindingIsActiveSnapshot = _bindingIsActive;
    ...
    protected override void CancelEditCore()
    {
        ExecuteLoad(() =>
        {
            ...
            BindingIsActive = _bindingIsActiveSnapshot;
            OnCancelEdit();
        });
...
public partial class CustomerProfileEditModel : EditModelBase
{
    ...
    protected override void ValidateSelf()
    {
        ...
        {
            SetError(nameof(BindingProfileId), ResolveRequiredErrorMessage(nameof(ProfileId), ProfileIdValue.DisplayName));
        }
        if (CustomerId is null)
        {
            SetError(nameof(BindingCustomerId), ResolveRequiredErrorMessage(nameof(CustomerId), CustomerIdValue.DisplayName));
...
public static class GeneratedSqlServerRepositoryServiceCollectionExtensions
{
    ...
    )
    {
        ...
        services.AddKeyedScoped<ICustomerProfileRepository>(
            serviceKey,
            (provider, _) => new CustomerProfileRepository(
                connectionFactory,
                provider.GetService<ISaveHookRegistry>()
            )
        );
