        ...
        set
        {
            ...
            if (!IsReverting)
            {
                ...
                else if (bool.TryParse(normalized, out var parsed))
                {
                    ...
                    {
                        SetError(nameof(BindingIsActive), string.Join(" / ", voErrors));
                    }
                }
                else
                {
        ...
        set
        {
            ...
            if (!IsReverting)
            {
                ...
                else if (int.TryParse(normalized, out var parsed))
                {
                    ...
                    {
                        SetError(nameof(BindingProfileId), string.Join(" / ", voErrors));
                    }
                }
                else
                {
    ...
    public string BindingBio
    {
        ...
        set
        {
            ...
            if (!IsReverting)
            {
                ...
                {
                    SetError(nameof(BindingBio), string.Join(" / ", voErrors));
                }
            }
        }
    }
