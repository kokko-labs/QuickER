...
// Content hash: sha256:2fb5f30b40859c486235cf2b16b5232cb9a58ada73309c1b509925c205c0d767
#nullable enable
...
/// <summary>Value object for the bio column</summary>
public sealed partial class BioValue
    : ValueObjectStringBase<BioValue>,
        IValueObject<BioValue, string>
{
    private BioValue(string value)
        : base(value) { }

    /// <summary>Creates the instance from an already-validated value (the public factories live in the base class; see <see cref="ValueObjectBaseCore{TSelf, TValue}.Create"/>).</summary>
    static BioValue IValueObject<BioValue, string>.New(string value) =>
        new(value);

    /// <summary>Auto-generated validation rules plus the user extension (OnValidate), called by the base class's Create / TryCreate / Validate.</summary>
    /// <remarks>An unimplemented OnValidate partial method takes its call away entirely, and an implemented one receives the error list by reference and possibly unallocated - so a value that passes every rule allocates nothing either way.</remarks>
    static void IValueObject<BioValue, string>.ValidateCore(string value, ref List<string>? errors)
    {
    ...
    /// <summary>Hands back the declared instance found by the GetDefinedInstance partial hook (the base class's Create / TryCreate consult this on every creation path).</summary>
    static bool IValueObject<BioValue, string>.TryGetDefined(string value, out BioValue? defined)
    {
        BioValue? found = null;
        GetDefinedInstance(value, ref found);
        defined = found;
    ...
    /// <summary>Hands the input shapes claimed by the ConvertCustomInput partial hook to TryCreateFrom / CreateFrom, ahead of the ordinary conversion.</summary>
    static bool IValueObject<BioValue>.TryConvertCustomInput(object raw, IFormatProvider? provider, out BioValue? result)
    {
        BioValue? custom = null;
        ConvertCustomInput(raw, provider, ref custom);
        result = custom;
        return custom is not null;
    }
    ...
    /// <summary>Custom input shape for TryCreateFrom / CreateFrom - a name for an enumeration-like value object, say (partial; a declared input notation and the ordinary conversion still apply when not implemented). Set result to claim the value; leave it null for anything not handled so the ordinary conversion runs. Never call TryCreateFrom / CreateFrom from inside (they consult this hook and the call would recurse), and do not throw - TryCreateFrom reports failures through its return value, and an exception here rides straight through that contract.</summary>
    static partial void ConvertCustomInput(object raw, IFormatProvider? provider, ref BioValue? result);

    /// <summary>Hands the absent inputs claimed by the ConvertAbsentInput partial hook to TryCreateFrom / CreateFrom, ahead of the ordinary null result.</summary>
    static bool IValueObject<BioValue>.TryConvertAbsentInput(IFormatProvider? provider, out BioValue? result)
    {
        BioValue? absent = null;
        ConvertAbsentInput(provider, ref absent);
        result = absent;
        return absent is not null;
    }
    ...
    /// <summary>Gets the display name of this value object (used in error messages and similar). Defaults to the column description, or the property name when unset. Replace it through GeneratedDisplayNames.Resolve, which resolves every generated display name and can switch on the member name.</summary>
    public static string DisplayName =>
        GeneratedDisplayNames.Resolve("Bio", null);
}
...
/// <summary>Value object for the delivery_date column</summary>
public sealed partial class DeliveryDateValue
    : ValueObjectDateTimeBase<DeliveryDateValue>,
        IValueObject<DeliveryDateValue, DateTime>
{
    private DeliveryDateValue(DateTime value)
        : base(value) { }

    /// <summary>Creates the instance from an already-validated value (the public factories live in the base class; see <see cref="ValueObjectBaseCore{TSelf, TValue}.Create"/>).</summary>
    static DeliveryDateValue IValueObject<DeliveryDateValue, DateTime>.New(DateTime value) =>
        new(value);

    /// <summary>Auto-generated validation rules plus the user extension (OnValidate), called by the base class's Create / TryCreate / Validate.</summary>
    /// <remarks>An unimplemented OnValidate partial method takes its call away entirely, and an implemented one receives the error list by reference and possibly unallocated - so a value that passes every rule allocates nothing either way.</remarks>
    static void IValueObject<DeliveryDateValue, DateTime>.ValidateCore(DateTime value, ref List<string>? errors)
    {
        OnValidate(value, ref errors);
    }

    /// <summary>User-defined additional validation (partial; zero cost when not implemented). The list arrives by reference and possibly unallocated - allocate it only when adding the first violation, the same shape ValidateCore itself uses ((errors ??= new List&lt;string&gt;()).Add(...)), so a value that passes adds no allocation.</summary>
    static partial void OnValidate(DateTime value, ref List<string>? errors);

    /// <summary>Hands back the declared instance found by the GetDefinedInstance partial hook (the base class's Create / TryCreate consult this on every creation path).</summary>
    static bool IValueObject<DeliveryDateValue, DateTime>.TryGetDefined(DateTime value, out DeliveryDateValue? defined)
    {
        DeliveryDateValue? found = null;
        GetDefinedInstance(value, ref found);
        defined = found;
        return found is not null;
    }
    ...
    /// <summary>Declared-instance lookup for an enumeration-like value object (partial; every value is built as a new instance when not implemented). Look the value up in a static table without allocating - this runs on every creation - and never call Create / TryCreate / TryCreateFrom from inside: every creation path runs through this hook and the call would recurse.</summary>
    static partial void GetDefinedInstance(DateTime value, ref DeliveryDateValue? defined);

    /// <summary>Hands the input shapes claimed by the ConvertCustomInput partial hook to TryCreateFrom / CreateFrom, ahead of the ordinary conversion.</summary>
    static bool IValueObject<DeliveryDateValue>.TryConvertCustomInput(object raw, IFormatProvider? provider, out DeliveryDateValue? result)
    {
        DeliveryDateValue? custom = null;
        ConvertCustomInput(raw, provider, ref custom);
        result = custom;
        return custom is not null;
    }
    ...
    /// <summary>Custom input shape for TryCreateFrom / CreateFrom - a name for an enumeration-like value object, say (partial; a declared input notation and the ordinary conversion still apply when not implemented). Set result to claim the value; leave it null for anything not handled so the ordinary conversion runs. Never call TryCreateFrom / CreateFrom from inside (they consult this hook and the call would recurse), and do not throw - TryCreateFrom reports failures through its return value, and an exception here rides straight through that contract.</summary>
    static partial void ConvertCustomInput(object raw, IFormatProvider? provider, ref DeliveryDateValue? result);

    /// <summary>Hands the absent inputs claimed by the ConvertAbsentInput partial hook to TryCreateFrom / CreateFrom, ahead of the ordinary null result.</summary>
    static bool IValueObject<DeliveryDateValue>.TryConvertAbsentInput(IFormatProvider? provider, out DeliveryDateValue? result)
    {
        DeliveryDateValue? absent = null;
        ConvertAbsentInput(provider, ref absent);
        result = absent;
        return absent is not null;
    }
    ...
    /// <summary>Absent input (null, DBNull, or an empty string) for TryCreateFrom / CreateFrom - a flag whose blank cell means a value of its own, say (partial; an absent input falls to a ClaimsAbsent declared instance or the ordinary null result when not implemented). Set result to claim the absent input; leave it null and the call succeeds with a null value object. This hook applies to TryCreateFrom / CreateFrom only - an edit model's blank input and a database NULL are unaffected. Never call TryCreateFrom / CreateFrom from inside (they consult this hook and the call would recurse), and do not throw - TryCreateFrom reports failures through its return value, and an exception here rides straight through that contract.</summary>
    static partial void ConvertAbsentInput(IFormatProvider? provider, ref DeliveryDateValue? result);

    /// <summary>Gets the display name of this value object (used in error messages and similar). Defaults to the column description, or the property name when unset. Replace it through GeneratedDisplayNames.Resolve, which resolves every generated display name and can switch on the member name.</summary>
    public static string DisplayName =>
        GeneratedDisplayNames.Resolve("DeliveryDate", null);
}

/// <summary>Value object for the is_active column</summary>
public sealed partial class IsActiveValue
    : ValueObjectBooleanBase<IsActiveValue>,
        IValueObject<IsActiveValue, bool>
{
    private IsActiveValue(bool value)
        : base(value) { }

    /// <summary>Creates the instance from an already-validated value (the public factories live in the base class; see <see cref="ValueObjectBaseCore{TSelf, TValue}.Create"/>).</summary>
    static IsActiveValue IValueObject<IsActiveValue, bool>.New(bool value) =>
        new(value);

    /// <summary>Auto-generated validation rules plus the user extension (OnValidate), called by the base class's Create / TryCreate / Validate.</summary>
    /// <remarks>An unimplemented OnValidate partial method takes its call away entirely, and an implemented one receives the error list by reference and possibly unallocated - so a value that passes every rule allocates nothing either way.</remarks>
    static void IValueObject<IsActiveValue, bool>.ValidateCore(bool value, ref List<string>? errors)
    {
        OnValidate(value, ref errors);
    }

    /// <summary>User-defined additional validation (partial; zero cost when not implemented). The list arrives by reference and possibly unallocated - allocate it only when adding the first violation, the same shape ValidateCore itself uses ((errors ??= new List&lt;string&gt;()).Add(...)), so a value that passes adds no allocation.</summary>
    static partial void OnValidate(bool value, ref List<string>? errors);

    /// <summary>Hands back the declared instance found by the GetDefinedInstance partial hook (the base class's Create / TryCreate consult this on every creation path).</summary>
    static bool IValueObject<IsActiveValue, bool>.TryGetDefined(bool value, out IsActiveValue? defined)
    {
        IsActiveValue? found = null;
        GetDefinedInstance(value, ref found);
        defined = found;
        return found is not null;
    }
    ...
    /// <summary>Declared-instance lookup for an enumeration-like value object (partial; every value is built as a new instance when not implemented). Look the value up in a static table without allocating - this runs on every creation - and never call Create / TryCreate / TryCreateFrom from inside: every creation path runs through this hook and the call would recurse.</summary>
    static partial void GetDefinedInstance(bool value, ref IsActiveValue? defined);

    /// <summary>Hands the input shapes claimed by the ConvertCustomInput partial hook to TryCreateFrom / CreateFrom, ahead of the ordinary conversion.</summary>
    static bool IValueObject<IsActiveValue>.TryConvertCustomInput(object raw, IFormatProvider? provider, out IsActiveValue? result)
    {
        IsActiveValue? custom = null;
        ConvertCustomInput(raw, provider, ref custom);
        result = custom;
        return custom is not null;
    }
    ...
    /// <summary>Custom input shape for TryCreateFrom / CreateFrom - a name for an enumeration-like value object, say (partial; a declared input notation and the ordinary conversion still apply when not implemented). Set result to claim the value; leave it null for anything not handled so the ordinary conversion runs. Never call TryCreateFrom / CreateFrom from inside (they consult this hook and the call would recurse), and do not throw - TryCreateFrom reports failures through its return value, and an exception here rides straight through that contract.</summary>
    static partial void ConvertCustomInput(object raw, IFormatProvider? provider, ref IsActiveValue? result);

    /// <summary>Hands the absent inputs claimed by the ConvertAbsentInput partial hook to TryCreateFrom / CreateFrom, ahead of the ordinary null result.</summary>
    static bool IValueObject<IsActiveValue>.TryConvertAbsentInput(IFormatProvider? provider, out IsActiveValue? result)
    {
        IsActiveValue? absent = null;
        ConvertAbsentInput(provider, ref absent);
        result = absent;
        return absent is not null;
    }
    ...
    /// <summary>Absent input (null, DBNull, or an empty string) for TryCreateFrom / CreateFrom - a flag whose blank cell means a value of its own, say (partial; an absent input falls to a ClaimsAbsent declared instance or the ordinary null result when not implemented). Set result to claim the absent input; leave it null and the call succeeds with a null value object. This hook applies to TryCreateFrom / CreateFrom only - an edit model's blank input and a database NULL are unaffected. Never call TryCreateFrom / CreateFrom from inside (they consult this hook and the call would recurse), and do not throw - TryCreateFrom reports failures through its return value, and an exception here rides straight through that contract.</summary>
    static partial void ConvertAbsentInput(IFormatProvider? provider, ref IsActiveValue? result);

    /// <summary>Gets the display name of this value object (used in error messages and similar). Defaults to the column description, or the property name when unset. Replace it through GeneratedDisplayNames.Resolve, which resolves every generated display name and can switch on the member name.</summary>
    public static string DisplayName =>
        GeneratedDisplayNames.Resolve("IsActive", null);
}
        ...
        IValueObject<OrderedAtValue, DateTime>
{
    ...
    /// <summary>Creates the instance from an already-validated value (the public factories live in the base class; see <see cref="ValueObjectBaseCore{TSelf, TValue}.Create"/>).</summary>
    static OrderedAtValue IValueObject<OrderedAtValue, DateTime>.New(DateTime value) =>
        new(value);

    /// <summary>Auto-generated validation rules plus the user extension (OnValidate), called by the base class's Create / TryCreate / Validate.</summary>
    /// <remarks>An unimplemented OnValidate partial method takes its call away entirely, and an implemented one receives the error list by reference and possibly unallocated - so a value that passes every rule allocates nothing either way.</remarks>
    static void IValueObject<OrderedAtValue, DateTime>.ValidateCore(DateTime value, ref List<string>? errors)
    {
        OnValidate(value, ref errors);
    }
    ...
    /// <summary>Hands back the declared instance found by the GetDefinedInstance partial hook (the base class's Create / TryCreate consult this on every creation path).</summary>
    static bool IValueObject<OrderedAtValue, DateTime>.TryGetDefined(DateTime value, out OrderedAtValue? defined)
    {
        OrderedAtValue? found = null;
        GetDefinedInstance(value, ref found);
        defined = found;
        return found is not null;
    }
    ...
    /// <summary>Declared-instance lookup for an enumeration-like value object (partial; every value is built as a new instance when not implemented). Look the value up in a static table without allocating - this runs on every creation - and never call Create / TryCreate / TryCreateFrom from inside: every creation path runs through this hook and the call would recurse.</summary>
    static partial void GetDefinedInstance(DateTime value, ref OrderedAtValue? defined);

    /// <summary>Hands the input shapes claimed by the ConvertCustomInput partial hook to TryCreateFrom / CreateFrom, ahead of the ordinary conversion.</summary>
    static bool IValueObject<OrderedAtValue>.TryConvertCustomInput(object raw, IFormatProvider? provider, out OrderedAtValue? result)
    {
        OrderedAtValue? custom = null;
        ConvertCustomInput(raw, provider, ref custom);
        result = custom;
        return custom is not null;
    }
    ...
    /// <summary>Custom input shape for TryCreateFrom / CreateFrom - a name for an enumeration-like value object, say (partial; a declared input notation and the ordinary conversion still apply when not implemented). Set result to claim the value; leave it null for anything not handled so the ordinary conversion runs. Never call TryCreateFrom / CreateFrom from inside (they consult this hook and the call would recurse), and do not throw - TryCreateFrom reports failures through its return value, and an exception here rides straight through that contract.</summary>
    static partial void ConvertCustomInput(object raw, IFormatProvider? provider, ref OrderedAtValue? result);

    /// <summary>Hands the absent inputs claimed by the ConvertAbsentInput partial hook to TryCreateFrom / CreateFrom, ahead of the ordinary null result.</summary>
    static bool IValueObject<OrderedAtValue>.TryConvertAbsentInput(IFormatProvider? provider, out OrderedAtValue? result)
    {
        OrderedAtValue? absent = null;
        ConvertAbsentInput(provider, ref absent);
        result = absent;
        return absent is not null;
    }
    ...
    /// <summary>Absent input (null, DBNull, or an empty string) for TryCreateFrom / CreateFrom - a flag whose blank cell means a value of its own, say (partial; an absent input falls to a ClaimsAbsent declared instance or the ordinary null result when not implemented). Set result to claim the absent input; leave it null and the call succeeds with a null value object. This hook applies to TryCreateFrom / CreateFrom only - an edit model's blank input and a database NULL are unaffected. Never call TryCreateFrom / CreateFrom from inside (they consult this hook and the call would recurse), and do not throw - TryCreateFrom reports failures through its return value, and an exception here rides straight through that contract.</summary>
    static partial void ConvertAbsentInput(IFormatProvider? provider, ref OrderedAtValue? result);

    /// <summary>Gets the display name of this value object (used in error messages and similar). Defaults to the column description, or the property name when unset. Replace it through GeneratedDisplayNames.Resolve, which resolves every generated display name and can switch on the member name.</summary>
    public static string DisplayName =>
        GeneratedDisplayNames.Resolve("OrderedAt", null);
}
...
public sealed partial class ProfileIdValue
    : ValueObjectOrderedBase<ProfileIdValue, int>,
        IValueObject<ProfileIdValue, int>
{
    private ProfileIdValue(int value)
        : base(value) { }

    /// <summary>Creates the instance from an already-validated value (the public factories live in the base class; see <see cref="ValueObjectBaseCore{TSelf, TValue}.Create"/>).</summary>
    static ProfileIdValue IValueObject<ProfileIdValue, int>.New(int value) =>
        new(value);

    /// <summary>Auto-generated validation rules plus the user extension (OnValidate), called by the base class's Create / TryCreate / Validate.</summary>
    /// <remarks>An unimplemented OnValidate partial method takes its call away entirely, and an implemented one receives the error list by reference and possibly unallocated - so a value that passes every rule allocates nothing either way.</remarks>
    static void IValueObject<ProfileIdValue, int>.ValidateCore(int value, ref List<string>? errors)
    {
        OnValidate(value, ref errors);
    }
    ...
    /// <summary>Hands back the declared instance found by the GetDefinedInstance partial hook (the base class's Create / TryCreate consult this on every creation path).</summary>
    static bool IValueObject<ProfileIdValue, int>.TryGetDefined(int value, out ProfileIdValue? defined)
    {
        ProfileIdValue? found = null;
        GetDefinedInstance(value, ref found);
        defined = found;
        return found is not null;
    }
    ...
    /// <summary>Declared-instance lookup for an enumeration-like value object (partial; every value is built as a new instance when not implemented). Look the value up in a static table without allocating - this runs on every creation - and never call Create / TryCreate / TryCreateFrom from inside: every creation path runs through this hook and the call would recurse.</summary>
    static partial void GetDefinedInstance(int value, ref ProfileIdValue? defined);

    /// <summary>Hands the input shapes claimed by the ConvertCustomInput partial hook to TryCreateFrom / CreateFrom, ahead of the ordinary conversion.</summary>
    static bool IValueObject<ProfileIdValue>.TryConvertCustomInput(object raw, IFormatProvider? provider, out ProfileIdValue? result)
    {
        ProfileIdValue? custom = null;
        ConvertCustomInput(raw, provider, ref custom);
        result = custom;
        return custom is not null;
    }
    ...
    /// <summary>Custom input shape for TryCreateFrom / CreateFrom - a name for an enumeration-like value object, say (partial; a declared input notation and the ordinary conversion still apply when not implemented). Set result to claim the value; leave it null for anything not handled so the ordinary conversion runs. Never call TryCreateFrom / CreateFrom from inside (they consult this hook and the call would recurse), and do not throw - TryCreateFrom reports failures through its return value, and an exception here rides straight through that contract.</summary>
    static partial void ConvertCustomInput(object raw, IFormatProvider? provider, ref ProfileIdValue? result);

    /// <summary>Hands the absent inputs claimed by the ConvertAbsentInput partial hook to TryCreateFrom / CreateFrom, ahead of the ordinary null result.</summary>
    static bool IValueObject<ProfileIdValue>.TryConvertAbsentInput(IFormatProvider? provider, out ProfileIdValue? result)
    {
        ProfileIdValue? absent = null;
        ConvertAbsentInput(provider, ref absent);
        result = absent;
        return absent is not null;
    }
    ...
    /// <summary>Absent input (null, DBNull, or an empty string) for TryCreateFrom / CreateFrom - a flag whose blank cell means a value of its own, say (partial; an absent input falls to a ClaimsAbsent declared instance or the ordinary null result when not implemented). Set result to claim the absent input; leave it null and the call succeeds with a null value object. This hook applies to TryCreateFrom / CreateFrom only - an edit model's blank input and a database NULL are unaffected. Never call TryCreateFrom / CreateFrom from inside (they consult this hook and the call would recurse), and do not throw - TryCreateFrom reports failures through its return value, and an exception here rides straight through that contract.</summary>
    static partial void ConvertAbsentInput(IFormatProvider? provider, ref ProfileIdValue? result);

    /// <summary>Gets the display name of this value object (used in error messages and similar). Defaults to the column description, or the property name when unset. Replace it through GeneratedDisplayNames.Resolve, which resolves every generated display name and can switch on the member name.</summary>
    public static string DisplayName =>
        GeneratedDisplayNames.Resolve("ProfileId", null);
}
...
public partial class CustomerEntity : EntityBase
{
    ...
    /// <summary>Property for the is_active column</summary>
    [Column("is_active")]
    [Required]
    [SqlColumnType(SqlDbType.Bit)]
...
public partial class OrderEntity : EntityBase
{
    ...
    /// <summary>Property for the delivery_date column</summary>
    [Column("delivery_date")]
    [SqlColumnType(SqlDbType.Date)]
    [DbColumnMeta("date")]
    public DeliveryDateValue? DeliveryDate { get; set; }
...
[UniqueConstraint("CustomerId", Name = "UQ_customer_profiles_customer_id")]
[UniqueConstraint("CustomerId", "Bio", Name = "UQ_customer_profiles_customer_id_bio")]
public partial class CustomerProfileEntity : EntityBase
{
    ...
    [SqlColumnType(SqlDbType.Int)]
    [DbColumnMeta("int32")]
    public ProfileIdValue ProfileId { get; set; } = null!;
...
public partial class CustomerEditModel : EditModelBase<CustomerEditModel>
{
    ...
    /// <summary>Confirmed value of IsActive.</summary>
    private IsActiveValue? _isActive;
    ...
    public IsActiveValue? IsActive
    {
        ...
        internal set
        {
            ...
            OnIsActiveChanging(oldValue, value);
            _isActive = value;
            OnIsActiveChanged(value);
            OnIsActiveChanged(oldValue, value);
            AfterConfirmedValueSet(nameof(IsActive));
        }
    }

    /// <summary>Called just before the confirmed value of IsActive changes (new value only; add processing via a partial implementation).</summary>
    partial void OnIsActiveChanging(IsActiveValue? value);

    /// <summary>Called just before the confirmed value of IsActive changes (old and new values; add processing via a partial implementation).</summary>
    partial void OnIsActiveChanging(IsActiveValue? oldValue, IsActiveValue? newValue);

    /// <summary>Called just after the confirmed value of IsActive changes (new value only; add processing via a partial implementation).</summary>
    partial void OnIsActiveChanged(IsActiveValue? value);

    /// <summary>Called just after the confirmed value of IsActive changes (old and new values; add processing via a partial implementation).</summary>
    partial void OnIsActiveChanged(IsActiveValue? oldValue, IsActiveValue? newValue);

    /// <summary>On-screen input binding string for IsActive (converted to the confirmed value when set).</summary>
    public string BindingIsActive
    {
        get => _bindingIsActive;
        set
        {
            if (!AcceptBindingInput(ref _bindingIsActive, value, nameof(BindingIsActive), out var normalized))
            {
                return;
            }

            switch (ConvertParsedValueObjectInput<IsActiveValue, bool>(normalized, out var converted, out var rejection))
            {
                case BindingConversion.Converted:
                    IsActive = converted;
                ...
                case BindingConversion.Rejected:
                    SetError(nameof(BindingIsActive), rejection);
                    break;

                default:
                    SetError(
                        nameof(BindingIsActive),
                        EditModelMessages.ParseFailed(nameof(IsActive), IsActiveValue.DisplayName, normalized, "bool")
                    );
                    break;
            }
        }
    ...
    private static readonly IReadOnlyList<EditModelColumn<CustomerEditModel>> _editModelColumns =
        new EditModelColumn<CustomerEditModel>[]
        {
            ...
            new(
                ...
                true,
                false,
                static () => IsActiveValue.DisplayName,
                static model => model.IsActive,
                static (model, value) => model.IsActive = (IsActiveValue?)value,
                static model => model.IsActive?.ToString() ?? string.Empty,
                static (model, input) => model.BindingIsActive = input
            ),
        };
...
public partial class OrderEditModel : EditModelBase<OrderEditModel>
{
    ...
    public string BindingOrderedAt
    {
        ...
        set
        {
            ...
            switch (ConvertParsedValueObjectInput<OrderedAtValue, DateTime>(normalized, out var converted, out var rejection))
            {
                case BindingConversion.Converted:
                    OrderedAt = converted;
                ...
                case BindingConversion.Rejected:
                    SetError(nameof(BindingOrderedAt), rejection);
                    break;

                default:
                    SetError(
                        nameof(BindingOrderedAt),
                        EditModelMessages.ParseFailed(nameof(OrderedAt), OrderedAtValue.DisplayName, normalized, "DateTime")
                    );
                    break;
            }
        }
    ...
    /// <summary>Confirmed value of DeliveryDate.</summary>
    private DeliveryDateValue? _deliveryDate;

    /// <summary>On-screen input string for DeliveryDate.</summary>
    private string _bindingDeliveryDate = string.Empty;

    /// <summary>Confirmed value of DeliveryDate (written by the input conversion and by the mapper when loading; treat it as read-only elsewhere).</summary>
    public DeliveryDateValue? DeliveryDate
    {
        get => _deliveryDate;
        internal set
        {
            if (EqualityComparer<DeliveryDateValue?>.Default.Equals(_deliveryDate, value))
            {
                return;
            }

            var oldValue = _deliveryDate;
            OnDeliveryDateChanging(value);
            OnDeliveryDateChanging(oldValue, value);
            _deliveryDate = value;
            OnDeliveryDateChanged(value);
            OnDeliveryDateChanged(oldValue, value);
            AfterConfirmedValueSet(nameof(DeliveryDate));
        }
    }

    /// <summary>Called just before the confirmed value of DeliveryDate changes (new value only; add processing via a partial implementation).</summary>
    partial void OnDeliveryDateChanging(DeliveryDateValue? value);

    /// <summary>Called just before the confirmed value of DeliveryDate changes (old and new values; add processing via a partial implementation).</summary>
    partial void OnDeliveryDateChanging(DeliveryDateValue? oldValue, DeliveryDateValue? newValue);

    /// <summary>Called just after the confirmed value of DeliveryDate changes (new value only; add processing via a partial implementation).</summary>
    partial void OnDeliveryDateChanged(DeliveryDateValue? value);

    /// <summary>Called just after the confirmed value of DeliveryDate changes (old and new values; add processing via a partial implementation).</summary>
    partial void OnDeliveryDateChanged(DeliveryDateValue? oldValue, DeliveryDateValue? newValue);

    /// <summary>On-screen input binding string for DeliveryDate (converted to the confirmed value when set).</summary>
    public string BindingDeliveryDate
    {
        get => _bindingDeliveryDate;
        set
        {
            if (!AcceptBindingInput(ref _bindingDeliveryDate, value, nameof(BindingDeliveryDate), out var normalized))
            {
                return;
            }

            switch (ConvertParsedValueObjectInput<DeliveryDateValue, DateTime>(normalized, out var converted, out var rejection))
            {
                case BindingConversion.Converted:
                    DeliveryDate = converted;
                    SetError(nameof(BindingDeliveryDate), null);
                    break;

                case BindingConversion.Rejected:
                    SetError(nameof(BindingDeliveryDate), rejection);
                    break;

                default:
                    SetError(
                        nameof(BindingDeliveryDate),
                        EditModelMessages.ParseFailed(nameof(DeliveryDate), DeliveryDateValue.DisplayName, normalized, "DateTime")
                    );
                    break;
            }
        }
    ...
    private static readonly IReadOnlyList<EditModelColumn<OrderEditModel>> _editModelColumns =
        new EditModelColumn<OrderEditModel>[]
        {
            ...
            new(
                ...
                false,
                false,
                static () => DeliveryDateValue.DisplayName,
                static model => model.DeliveryDate,
                static (model, value) => model.DeliveryDate = (DeliveryDateValue?)value,
                static model => model.DeliveryDate?.Value.ToString("d") ?? string.Empty,
                static (model, input) => model.BindingDeliveryDate = input
            ),
        };
...
public partial class CustomerProfileEditModel : EditModelBase<CustomerProfileEditModel>
{
    // Each column keeps two representations: the confirmed value and the on-screen input string (conversion errors are held by the error dictionary).
    /// <summary>Confirmed value of ProfileId.</summary>
    private ProfileIdValue? _profileId;
    ...
    public ProfileIdValue? ProfileId
    {
        ...
        internal set
        {
            ...
            AfterConfirmedValueSet(nameof(ProfileId));
        }
    }
    ...
    partial void OnProfileIdChanging(ProfileIdValue? value);
    ...
    partial void OnProfileIdChanging(ProfileIdValue? oldValue, ProfileIdValue? newValue);
    ...
    partial void OnProfileIdChanged(ProfileIdValue? value);
    ...
    partial void OnProfileIdChanged(ProfileIdValue? oldValue, ProfileIdValue? newValue);
    ...
    public string BindingProfileId
    {
        ...
        set
        {
            if (!AcceptBindingInput(ref _bindingProfileId, value, nameof(BindingProfileId), out var normalized))
            {
                return;
            }

            switch (ConvertParsedValueObjectInput<ProfileIdValue, int>(normalized, out var converted, out var rejection))
            {
                case BindingConversion.Converted:
                    ProfileId = converted;
                ...
                case BindingConversion.Rejected:
                    SetError(nameof(BindingProfileId), rejection);
                    break;

                default:
                    SetError(
                        nameof(BindingProfileId),
                        EditModelMessages.ParseFailed(nameof(ProfileId), ProfileIdValue.DisplayName, normalized, "int")
                    );
                    break;
            }
        }
    ...
    public BioValue? Bio
    {
        ...
        internal set
        {
            ...
            AfterConfirmedValueSet(nameof(Bio));
        }
    }
    ...
    partial void OnBioChanging(BioValue? value);
    ...
    partial void OnBioChanging(BioValue? oldValue, BioValue? newValue);
    ...
    partial void OnBioChanged(BioValue? value);
    ...
    partial void OnBioChanged(BioValue? oldValue, BioValue? newValue);
    ...
    public string BindingBio
    {
        ...
        set
        {
            if (!AcceptBindingInput(ref _bindingBio, value, nameof(BindingBio), out var normalized))
            {
                return;
            }

            if (ConvertValueObjectInput<BioValue>(normalized, out var converted, out var rejection) == BindingConversion.Converted)
            {
                Bio = converted;
            ...
            {
                SetError(nameof(BindingBio), rejection);
            }
        }
    }
    ...
    /// <summary>The columns of this edit model as data (input of the shared required check, input revert, row-edit snapshot, and duplicate-error mapping).</summary>
    private static readonly IReadOnlyList<EditModelColumn<CustomerProfileEditModel>> _editModelColumns =
        new EditModelColumn<CustomerProfileEditModel>[]
        {
            new(
                nameof(ProfileId),
                nameof(BindingProfileId),
                true,
                false,
                static () => ProfileIdValue.DisplayName,
                static model => model.ProfileId,
                static (model, value) => model.ProfileId = (ProfileIdValue?)value,
                static model => model.ProfileId?.ToString() ?? string.Empty,
                static (model, input) => model.BindingProfileId = input
            ),
            new(
                nameof(CustomerId),
                nameof(BindingCustomerId),
            ...
            new(
                ...
                false,
                false,
                static () => BioValue.DisplayName,
                static model => model.Bio,
                static (model, value) => model.Bio = (BioValue?)value,
                static model => model.Bio?.ToString() ?? string.Empty,
                static (model, input) => model.BindingBio = input
            ),
        };

    /// <inheritdoc />
    protected override IReadOnlyList<EditModelColumn<CustomerProfileEditModel>> EditModelColumns =>
        _editModelColumns;
    ...
    /// <summary>UNIQUE constraints of the customer_profiles table, with compiled accessors for their member values (input of the duplicate check inside a collection).</summary>
    private static readonly IReadOnlyList<EditModelUniquenessConstraint> _uniquenessConstraints =
        new EditModelUniquenessConstraint[]
        {
            new(
                ...
                static model => new object?[] { ((CustomerProfileEditModel)model).CustomerId }
            ),
            new(
                "UQ_customer_profiles_customer_id_bio",
                new[] { nameof(CustomerId), nameof(Bio) },
                static model =>
                    new object?[]
                    {
                        ((CustomerProfileEditModel)model).CustomerId,
                        ((CustomerProfileEditModel)model).Bio,
                    }
            ),
        };
    ...
    : MapperBase<CustomerEntity, CustomerEditModel>
{
    ...
    /// <remarks>Every conversion creates a fresh entity, so this also fires when an existing edit model is converted (<c>CreateEntity(editModel, …)</c>), and the RowState at this point is always Added - the edit model's state is transferred later, at the end of the column copy.</remarks>
    ...
    )
    {
        ...
        // A removed row takes part in the save through its key alone, so an absent value is skipped instead of enforced.
        if (!editModel.IsRemoved || editModel.Name is not null)
        {
        ...
        // A removed row takes part in the save through its key alone, so an absent value is skipped instead of enforced.
        if (!editModel.IsRemoved || editModel.IsActive is not null)
        {
            entity.IsActive = Required(editModel.IsActive, nameof(editModel.IsActive));
        }
        ...
        entity.CustomerProfile = editModel.CustomerProfile is not { } childCustomerProfile || (!includeRemoved && childCustomerProfile.IsRemoved) ? null : new CustomerProfileMapper().CreateEntity(childCustomerProfile, includeRemoved);
    ...
    : MapperBase<OrderEntity, OrderEditModel>
{
    ...
    )
    {
        ...
        // A removed row takes part in the save through its key alone, so an absent value is skipped instead of enforced.
        if (!editModel.IsRemoved || editModel.CustomerId is not null)
        {
            entity.CustomerId = Required(editModel.CustomerId, nameof(editModel.CustomerId));
        }
    ...
    protected override void LoadColumns(OrderEntity entity, OrderEditModel editModel)
    {
        ...
        editModel.DeliveryDate = entity.DeliveryDate;
    }
...
{
    /// <inheritdoc />
    protected override void AfterEntityCreated(CustomerProfileEntity entity) =>
        OnEntityCreated(entity);
    ...
    /// <inheritdoc />
    protected override void AfterEditModelCreated(CustomerProfileEditModel editModel) =>
        OnEditModelCreated(editModel);
    ...
    {
        entity.ProfileId = Required(editModel.ProfileId, nameof(editModel.ProfileId));
    ...
    /// <inheritdoc />
    protected override void LoadColumns(CustomerProfileEntity entity, CustomerProfileEditModel editModel)
    {
    ...
    /// <inheritdoc />
    protected override void CompleteLoad(CustomerProfileEntity entity, CustomerProfileEditModel editModel)
    {
        OnEditModelLoaded(entity, editModel);
    }
...
public static class GeneratedSqlServerRepositoryServiceCollectionExtensions
{
    ...
    )
    {
        ...
        AddRepository<ICustomerRepository>(
            (factory, hooks, executor) => new CustomerRepository(factory, hooks, executor)
        );
        AddRepository<IOrderRepository>(
            (factory, hooks, executor) => new OrderRepository(factory, hooks, executor)
        );
        AddRepository<ICustomerProfileRepository>(
            (factory, hooks, executor) => new CustomerProfileRepository(factory, hooks, executor)
        );
...
) : SqlServerRepository<OrderEntity, OrderIdValue>(connectionFactory, saveHooks, sqlExecutor), IOrderRepository
{
    ...
    public Task<IReadOnlyList<OrderEntity>> SearchMemoContainsAsync(string keyword, CancellationToken cancellationToken = default) =>
        Query().Where(e => (e.Memo != null && e.Memo!.Contains(keyword))).OrderBy(e => e.OrderId).ToListAsync(cancellationToken);
...
internal static class CustomerProfileUniquenessConstraints
{
    ...
    public static readonly UniquenessConstraintSet<CustomerProfileEntity> Set =
...
public sealed partial class CustomerProfileRepository(
    ...
    ISaveHookRegistry? saveHooks = null,
    ISqlExecutor? sqlExecutor = null
) : SqlServerRepository<CustomerProfileEntity, ProfileIdValue>(connectionFactory, saveHooks, sqlExecutor), ICustomerProfileRepository
{
    /// <inheritdoc />
    protected override UniquenessConstraintSet<CustomerProfileEntity> UniquenessConstraints =>
        CustomerProfileUniquenessConstraints.Set;
...
public static class SqlQueryExtensions
{
    ...
    /// <summary>Fetches the single entity with the given key - the same key the repository contract's GetByIdAsync takes - and returns null when no row matches.</summary>
    /// <remarks>Combine it with Include or IncludeGraph to fetch that entity together with its graph in one call.</remarks>
    public static Task<CustomerProfileEntity?> GetByIdAsync(
        this SqlQuery<CustomerProfileEntity> query,
        ProfileIdValue id,
        CancellationToken cancellationToken = default
    ) => query.Where(entity => entity.ProfileId == id).FirstOrDefaultAsync(cancellationToken);

    /// <summary>Fetches the single entity with the given key, keeping the Include chain written just before it (returns null when no row matches).</summary>
    public static Task<CustomerProfileEntity?> GetByIdAsync<TProperty>(
        this IncludableSqlQuery<CustomerProfileEntity, TProperty> query,
        ProfileIdValue id,
        CancellationToken cancellationToken = default
    ) => query.Where(entity => entity.ProfileId == id).FirstOrDefaultAsync(cancellationToken);
}
...
public partial class QuickErDbContext : DbContext
{
    ...
    /// <summary>DbSet for CustomerProfileEntity.</summary>
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<OrderEntity>(entity =>
        {
            ...
            entity.Property(e => e.DeliveryDate).HasColumnName("delivery_date").HasConversion(v => v!.Value, v => DeliveryDateValue.Create(v!));
        });
...
/// <remarks>
/// <para>
/// Implements the same contract as QuickER's SQL Server implementation (<see cref="SqlServerRepositoryCore{TEntity, TKey}"/>) on top of a DbContext.
...
/// <summary>EF Core implementation of the repository for CustomerProfileEntity.</summary>
public sealed partial class EfCoreCustomerProfileRepository(
    IDbContextFactory<QuickErDbContext> contextFactory,
    ISaveHookRegistry? saveHooks = null,
    ISqlExecutor? sqlExecutor = null
) : EfCoreRepository<CustomerProfileEntity, ProfileIdValue, QuickErDbContext>(contextFactory, saveHooks, sqlExecutor), ICustomerProfileRepository
{
    /// <inheritdoc />
    protected override UniquenessConstraintSet<CustomerProfileEntity> UniquenessConstraints =>
        CustomerProfileUniquenessConstraints.Set;
