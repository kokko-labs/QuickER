...
// Content hash: sha256:bf0e64fb3df4357dc26c9ded7b132a61c2e182156712692820d028a9ee898305
#nullable enable
        ...
        IValueObject<GadgetIdValue, int>
{
    ...
    static GadgetIdValue IValueObject<GadgetIdValue, int>.New(int value) =>
        new(value);
    ...
    static void IValueObject<GadgetIdValue, int>.ValidateCore(int value, ref List<string>? errors)
    {
    ...
    static bool IValueObject<GadgetIdValue, int>.TryGetDefined(int value, out GadgetIdValue? defined)
    {
        GadgetIdValue? found = null;
    ...
    static partial void GetDefinedInstance(int value, ref GadgetIdValue? defined);
    ...
    static bool IValueObject<GadgetIdValue>.TryConvertCustomInput(object raw, IFormatProvider? provider, out GadgetIdValue? result)
    {
        GadgetIdValue? custom = null;
    ...
    static partial void ConvertCustomInput(object raw, IFormatProvider? provider, ref GadgetIdValue? result);
    ...
    static bool IValueObject<GadgetIdValue>.TryConvertAbsentInput(IFormatProvider? provider, out GadgetIdValue? result)
    {
        GadgetIdValue? absent = null;
    ...
    static partial void ConvertAbsentInput(IFormatProvider? provider, ref GadgetIdValue? result);
    ...
    public static string DisplayName =>
        GeneratedDisplayNames.Resolve("GadgetId", null);
}
        ...
        IValueObject<NoteIdValue, int>
{
    ...
    /// <summary>Creates the instance from an already-validated value (the public factories live in the base class; see <see cref="ValueObjectBaseCore{TSelf, TValue}.Create"/>).</summary>
    static NoteIdValue IValueObject<NoteIdValue, int>.New(int value) =>
        new(value);

    /// <summary>Auto-generated validation rules plus the user extension (OnValidate), called by the base class's Create / TryCreate / Validate.</summary>
    /// <remarks>An unimplemented OnValidate partial method takes its call away entirely, and an implemented one receives the error list by reference and possibly unallocated - so a value that passes every rule allocates nothing either way.</remarks>
    static void IValueObject<NoteIdValue, int>.ValidateCore(int value, ref List<string>? errors)
    {
        OnValidate(value, ref errors);
    }
    ...
    /// <summary>Hands back the declared instance found by the GetDefinedInstance partial hook (the base class's Create / TryCreate consult this on every creation path).</summary>
    static bool IValueObject<NoteIdValue, int>.TryGetDefined(int value, out NoteIdValue? defined)
    {
        NoteIdValue? found = null;
        GetDefinedInstance(value, ref found);
        defined = found;
        return found is not null;
    }
    ...
    /// <summary>Declared-instance lookup for an enumeration-like value object (partial; every value is built as a new instance when not implemented). Look the value up in a static table without allocating - this runs on every creation - and never call Create / TryCreate / TryCreateFrom from inside: every creation path runs through this hook and the call would recurse.</summary>
    static partial void GetDefinedInstance(int value, ref NoteIdValue? defined);

    /// <summary>Hands the input shapes claimed by the ConvertCustomInput partial hook to TryCreateFrom / CreateFrom, ahead of the ordinary conversion.</summary>
    static bool IValueObject<NoteIdValue>.TryConvertCustomInput(object raw, IFormatProvider? provider, out NoteIdValue? result)
    {
        NoteIdValue? custom = null;
        ConvertCustomInput(raw, provider, ref custom);
        result = custom;
        return custom is not null;
    }
    ...
    /// <summary>Custom input shape for TryCreateFrom / CreateFrom - a name for an enumeration-like value object, say (partial; a declared input notation and the ordinary conversion still apply when not implemented). Set result to claim the value; leave it null for anything not handled so the ordinary conversion runs. Never call TryCreateFrom / CreateFrom from inside (they consult this hook and the call would recurse), and do not throw - TryCreateFrom reports failures through its return value, and an exception here rides straight through that contract.</summary>
    static partial void ConvertCustomInput(object raw, IFormatProvider? provider, ref NoteIdValue? result);

    /// <summary>Hands the absent inputs claimed by the ConvertAbsentInput partial hook to TryCreateFrom / CreateFrom, ahead of the ordinary null result.</summary>
    static bool IValueObject<NoteIdValue>.TryConvertAbsentInput(IFormatProvider? provider, out NoteIdValue? result)
    {
        NoteIdValue? absent = null;
        ConvertAbsentInput(provider, ref absent);
        result = absent;
        return absent is not null;
    }
    ...
    /// <summary>Absent input (null, DBNull, or an empty string) for TryCreateFrom / CreateFrom - a flag whose blank cell means a value of its own, say (partial; an absent input falls to a ClaimsAbsent declared instance or the ordinary null result when not implemented). Set result to claim the absent input; leave it null and the call succeeds with a null value object. This hook applies to TryCreateFrom / CreateFrom only - an edit model's blank input and a database NULL are unaffected. Never call TryCreateFrom / CreateFrom from inside (they consult this hook and the call would recurse), and do not throw - TryCreateFrom reports failures through its return value, and an exception here rides straight through that contract.</summary>
    static partial void ConvertAbsentInput(IFormatProvider? provider, ref NoteIdValue? result);

    /// <summary>Gets the display name of this value object (used in error messages and similar). Defaults to the column description, or the property name when unset. Replace it through GeneratedDisplayNames.Resolve, which resolves every generated display name and can switch on the member name.</summary>
    public static string DisplayName =>
        GeneratedDisplayNames.Resolve("NoteId", null);
}
        ...
        IValueObject<NoteValue, string>
{
    ...
    /// <summary>Creates the instance from an already-validated value (the public factories live in the base class; see <see cref="ValueObjectBaseCore{TSelf, TValue}.Create"/>).</summary>
    static NoteValue IValueObject<NoteValue, string>.New(string value) =>
        new(value);

    /// <summary>Auto-generated validation rules plus the user extension (OnValidate), called by the base class's Create / TryCreate / Validate.</summary>
    /// <remarks>An unimplemented OnValidate partial method takes its call away entirely, and an implemented one receives the error list by reference and possibly unallocated - so a value that passes every rule allocates nothing either way.</remarks>
    static void IValueObject<NoteValue, string>.ValidateCore(string value, ref List<string>? errors)
    {
        // A value object never wraps null (a nullable column keeps the property itself null),
        // so a null input is reported as a validation error instead of throwing from the checks below.
        if (!ValueObjectRules.ValidateRequired(value, DisplayName, ref errors))
        ...
        ValueObjectStringRules.ValidateMaxLength(value, 100, DisplayName, ref errors);
        OnValidate(value, ref errors);
    }
    ...
    /// <summary>Hands back the declared instance found by the GetDefinedInstance partial hook (the base class's Create / TryCreate consult this on every creation path).</summary>
    static bool IValueObject<NoteValue, string>.TryGetDefined(string value, out NoteValue? defined)
    {
        NoteValue? found = null;
        GetDefinedInstance(value, ref found);
        defined = found;
        return found is not null;
    }
    ...
    /// <summary>Declared-instance lookup for an enumeration-like value object (partial; every value is built as a new instance when not implemented). Look the value up in a static table without allocating - this runs on every creation - and never call Create / TryCreate / TryCreateFrom from inside: every creation path runs through this hook and the call would recurse.</summary>
    static partial void GetDefinedInstance(string value, ref NoteValue? defined);

    /// <summary>Hands the input shapes claimed by the ConvertCustomInput partial hook to TryCreateFrom / CreateFrom, ahead of the ordinary conversion.</summary>
    static bool IValueObject<NoteValue>.TryConvertCustomInput(object raw, IFormatProvider? provider, out NoteValue? result)
    {
        NoteValue? custom = null;
        ConvertCustomInput(raw, provider, ref custom);
        result = custom;
        return custom is not null;
    }
    ...
    /// <summary>Custom input shape for TryCreateFrom / CreateFrom - a name for an enumeration-like value object, say (partial; a declared input notation and the ordinary conversion still apply when not implemented). Set result to claim the value; leave it null for anything not handled so the ordinary conversion runs. Never call TryCreateFrom / CreateFrom from inside (they consult this hook and the call would recurse), and do not throw - TryCreateFrom reports failures through its return value, and an exception here rides straight through that contract.</summary>
    static partial void ConvertCustomInput(object raw, IFormatProvider? provider, ref NoteValue? result);

    /// <summary>Hands the absent inputs claimed by the ConvertAbsentInput partial hook to TryCreateFrom / CreateFrom, ahead of the ordinary null result.</summary>
    static bool IValueObject<NoteValue>.TryConvertAbsentInput(IFormatProvider? provider, out NoteValue? result)
    {
        NoteValue? absent = null;
        ConvertAbsentInput(provider, ref absent);
        result = absent;
        return absent is not null;
    }
    ...
    /// <summary>Absent input (null, DBNull, or an empty string) for TryCreateFrom / CreateFrom - a flag whose blank cell means a value of its own, say (partial; an absent input falls to a ClaimsAbsent declared instance or the ordinary null result when not implemented). Set result to claim the absent input; leave it null and the call succeeds with a null value object. This hook applies to TryCreateFrom / CreateFrom only - an edit model's blank input and a database NULL are unaffected. Never call TryCreateFrom / CreateFrom from inside (they consult this hook and the call would recurse), and do not throw - TryCreateFrom reports failures through its return value, and an exception here rides straight through that contract.</summary>
    static partial void ConvertAbsentInput(IFormatProvider? provider, ref NoteValue? result);

    /// <summary>Gets the display name of this value object (used in error messages and similar). Defaults to the column description, or the property name when unset. Replace it through GeneratedDisplayNames.Resolve, which resolves every generated display name and can switch on the member name.</summary>
    public static string DisplayName =>
        GeneratedDisplayNames.Resolve("Note", null);
}
...
public partial class GadgetEditModel : EditModelBase<GadgetEditModel>
{
    ...
    /// <summary>Confirmed value of GadgetId (written by the input conversion and by the mapper when loading; treat it as read-only elsewhere).</summary>
            ...
            switch (ConvertParsedValueObjectInput<GadgetIdValue, int>(normalized, out var converted, out var rejection))
            {
                ...
                default:
                    SetError(
                        ...
                        EditModelMessages.ParseFailed(nameof(GadgetId), GadgetIdValue.DisplayName, normalized, "int")
                    );
                    break;
            }
        }
            ...
            switch (ConvertBinaryValueObjectInput<RowVerValue>(normalized, out var converted, out var rejection))
            {
                ...
                default:
                    SetError(
                        ...
                        EditModelMessages.ParseFailed(nameof(RowVer), RowVerValue.DisplayName, normalized, "byte[]")
                    );
                    break;
            }
        }
    ...
    {
        get => GetChildren(_gadgetNotes);
        set => SetChildren(ref _gadgetNotes, value, nameof(GadgetNotes));
    }
    ...
    private static readonly IReadOnlyList<EditModelColumn<GadgetEditModel>> _editModelColumns =
        new EditModelColumn<GadgetEditModel>[]
        {
            new(
                nameof(GadgetId),
                nameof(BindingGadgetId),
                true,
                false,
                static () => GadgetIdValue.DisplayName,
                static model => model.GadgetId,
                static (model, value) => model.GadgetId = (GadgetIdValue?)value,
                static model => model.GadgetId?.ToString() ?? string.Empty,
                static (model, input) => model.BindingGadgetId = input
            ),
            new(
                nameof(Name),
                nameof(BindingName),
            ...
            new(
                ...
                false,
                false,
                static () => RowVerValue.DisplayName,
                static model => model.RowVer,
                static (model, value) => model.RowVer = (RowVerValue?)value,
                static model => model.RowVer?.ToString() ?? string.Empty,
                static (model, input) => model.BindingRowVer = input
            ),
        };

    /// <inheritdoc />
    protected override IReadOnlyList<EditModelColumn<GadgetEditModel>> EditModelColumns =>
        _editModelColumns;
...
public partial class GadgetNoteEditModel : EditModelBase<GadgetNoteEditModel>
{
    // Each column keeps two representations: the confirmed value and the on-screen input string (conversion errors are held by the error dictionary).
            ...
            switch (ConvertParsedValueObjectInput<NoteIdValue, int>(normalized, out var converted, out var rejection))
            {
                ...
                default:
                    SetError(
                        ...
                        EditModelMessages.ParseFailed(nameof(NoteId), NoteIdValue.DisplayName, normalized, "int")
                    );
                    break;
            }
        }
    ...
    // ---- navigation ----
    /// <summary>Gadget navigation property (reference to the parent side).</summary>
    /// <remarks>
    ...
    /// </remarks>
    public GadgetEditModel? Gadget { get; set; }

    /// <summary>The columns of this edit model as data (input of the shared required check, input revert, row-edit snapshot, and duplicate-error mapping).</summary>
    private static readonly IReadOnlyList<EditModelColumn<GadgetNoteEditModel>> _editModelColumns =
        new EditModelColumn<GadgetNoteEditModel>[]
        {
            new(
                nameof(NoteId),
                nameof(BindingNoteId),
                true,
                false,
                static () => NoteIdValue.DisplayName,
                static model => model.NoteId,
                static (model, value) => model.NoteId = (NoteIdValue?)value,
                static model => model.NoteId?.ToString() ?? string.Empty,
                static (model, input) => model.BindingNoteId = input
            ),
            new(
                nameof(GadgetId),
                nameof(BindingGadgetId),
            ...
            new(
                ...
                true,
                false,
                static () => NoteValue.DisplayName,
                static model => model.Note,
                static (model, value) => model.Note = (NoteValue?)value,
                static model => model.Note?.ToString() ?? string.Empty,
                static (model, input) => model.BindingNote = input
            ),
            new(
                nameof(RowVer),
                nameof(BindingRowVer),
    ...
    /// <inheritdoc />
    protected override IReadOnlyList<EditModelColumn<GadgetNoteEditModel>> EditModelColumns =>
        _editModelColumns;
...
{
    /// <inheritdoc />
    protected override void AfterEntityCreated(GadgetEntity entity) =>
    ...
    /// <inheritdoc />
    protected override void AfterEditModelCreated(GadgetEditModel editModel) =>
    ...
    {
        entity.GadgetId = Required(editModel.GadgetId, nameof(editModel.GadgetId));
    ...
    /// <inheritdoc />
    protected override void LoadColumns(GadgetEntity entity, GadgetEditModel editModel)
    {
        editModel.GadgetId = entity.GadgetId;
        editModel.Name = entity.Name;
        editModel.RowVer = entity.RowVer?.CopyValue();
    }

    /// <inheritdoc />
    protected override void CompleteLoad(GadgetEntity entity, GadgetEditModel editModel)
    {
...
{
    /// <inheritdoc />
    protected override void AfterEntityCreated(GadgetNoteEntity entity) =>
        OnEntityCreated(entity);
    ...
    /// <inheritdoc />
    protected override void AfterEditModelCreated(GadgetNoteEditModel editModel) =>
        OnEditModelCreated(editModel);
    ...
    {
        entity.NoteId = Required(editModel.NoteId, nameof(editModel.NoteId));

        // A removed row takes part in the save through its key alone, so an absent value is skipped instead of enforced.
        if (!editModel.IsRemoved || editModel.GadgetId is not null)
        {
            entity.GadgetId = Required(editModel.GadgetId, nameof(editModel.GadgetId));
        }

        // A removed row takes part in the save through its key alone, so an absent value is skipped instead of enforced.
        if (!editModel.IsRemoved || editModel.Note is not null)
        {
            entity.Note = Required(editModel.Note, nameof(editModel.Note));
        }
    ...
    /// <inheritdoc />
    protected override void LoadColumns(GadgetNoteEntity entity, GadgetNoteEditModel editModel)
    {
    ...
    /// <inheritdoc />
    protected override void CompleteLoad(GadgetNoteEntity entity, GadgetNoteEditModel editModel)
    {
        OnEditModelLoaded(entity, editModel);
    }
...
public static class SqlQueryExtensions
{
    ...
    {
        var n0 = new IncludeNode(typeof(GadgetEntity).GetProperty(nameof(GadgetEntity.GadgetNotes))!);
        return new IncludeNode[] { n0 };
    });

    /// <summary>Includes the cascade graph of GadgetEntity - the same child-direction navigations a graph save walks. A navigation pointing back to a table already on the path from the root is not followed.</summary>
