...
/// <remarks>
/// <para>
/// 入力の図は方言可搬フィクスチャと同一だが、オプションがQuickER 版 Repository のマルチターゲット
    ...
    public void CommittedMultiTargetFixture_MatchesRegeneratedOutput()
    {
        ...
        FixtureDriftHarness.VerifyOrRegenerate(
            ...
            "コミット済みマルチターゲットフィクスチャが現在のテンプレート出力と乖離しています。"
                + "MultiTargetPortableFixtureDefinition（sqlserver / sqlite のQuickER 版 Repository・EF Core なし）から再生成が必要です。"
        );
    }
}
